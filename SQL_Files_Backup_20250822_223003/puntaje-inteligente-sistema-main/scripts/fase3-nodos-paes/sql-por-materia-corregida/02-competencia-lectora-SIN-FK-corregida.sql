-- =====================================================
-- COMPETENCIA LECTORA - 30 NODOS PAES (SIN FK - CORREGIDA)
-- Comprensión y análisis textual con skill_id como TEXT
...
('CL-03', 'Secuenciación de eventos narrativos', 
 ...
 ARRAY['sequence_ordering', 'chronological_analysis'], get_test_text(1)),
...
('CL-04', 'Identificación de personajes y roles', 
 ...
 ARRAY['character_identification', 'role_analysis'], get_test_text(1)),
...
('CL-05', 'Comprensión de relaciones causales explícitas', 
 ...
 ARRAY['causal_relationship_analysis', 'logical_connections'], get_test_text(1)),
...
('CL-06', 'Localización de datos específicos', 
 ...
 ARRAY['data_location', 'specific_information'], get_test_text(1)),
...
('CL-07', 'Identificación de definiciones y conceptos', 
 ...
 ARRAY['definition_identification', 'concept_recognition'], get_test_text(1)),
...
('CL-08', 'Comprensión de instrucciones y procedimientos', 
 ...
 ARRAY['procedural_comprehension', 'instruction_following'], get_test_text(1)),
...
('CL-09', 'Identificación de ejemplos y casos', 
 ...
 ARRAY['interpretar-relacionar', 'analizar-sintetizar'], 
 'contemporáneo', 'universal', 'textual', 'comprender', 'básico', 1.0, 2.2,
 ARRAY['example_identification', 'illustration_recognition'], get_test_text(1)),
...
('CL-10', 'Comprensión de descripciones detalladas', 
 ...
 ARRAY['descriptive_comprehension', 'detail_analysis'], get_test_text(1)),
...
('CL-11', 'Inferencia de información implícita', 
 ...
 ARRAY['implicit_inference', 'deductive_reasoning'], get_test_text(1)),
...
('CL-12', 'Deducción de motivaciones de personajes', 
 ...
 ARRAY['character_motivation_analysis', 'psychological_inference'], get_test_text(1)),
...
('CL-15', 'Deducción del significado contextual', 
 ...
 ARRAY['localizar-informacion', 'analizar-sintetizar'], 
 'contemporáneo', 'universal', 'textual', 'comprender', 'intermedio', 1.2, 2.8,
 ARRAY['contextual_meaning_inference', 'vocabulary_deduction'], get_test_text(1)),

('CL-16', 'Inferencia de propósito comunicativo', 
 'Deduce la intención del autor al escribir el texto', 
 'COMPETENCIA_LECTORA', get_skill_text('evaluar-reflexionar'), 
 ARRAY['interpretar-relacionar', 'analizar-sintetizar'], 
 'contemporáneo', 'universal', 'textual', 'evaluar', 'avanzado', 1.5, 4.0,
 ARRAY['communicative_purpose_analysis', 'authorial_intent'], get_test_text(1)),
...
('CL-17', 'Deducción de audiencia objetivo', 
 ...
 ARRAY['target_audience_analysis', 'reader_identification'], get_test_text(1)),
...
('CL-18', 'Inferencia de tono y atmósfera', 
 ...
 ARRAY['tone_analysis', 'atmospheric_inference'], get_test_text(1)),
...
('CL-19', 'Deducción de consecuencias implícitas', 
 ...
 ARRAY['consequence_inference', 'causal_projection'], get_test_text(1)),
...
('CL-20', 'Inferencia de información faltante', 
 ...
 ARRAY['gap_filling_inference', 'missing_information_deduction'], get_test_text(1)),
...
('CL-21', 'Evaluación de credibilidad de fuentes', 
 ...
 ARRAY['source_credibility_evaluation', 'authority_analysis'], get_test_text(1)),
...
('CL-22', 'Identificación de sesgos y perspectivas', 
 ...
 ARRAY['bias_identification', 'perspective_analysis'], get_test_text(1)),
...
('CL-23', 'Análisis de argumentos y evidencias', 
 ...
 ARRAY['argument_analysis', 'evidence_evaluation'], get_test_text(1)),
...
('CL-24', 'Detección de falacias lógicas', 
 ...
 ARRAY['analizar-sintetizar', 'interpretar-relacionar'], 
 'contemporáneo', 'universal', 'textual', 'evaluar', 'avanzado', 1.5, 4.2,
 ARRAY['logical_fallacy_detection', 'reasoning_error_analysis'], get_test_text(1)),
...
('CL-25', 'Comparación de múltiples perspectivas', 
 ...
 'contemporáneo', 'universal', 'textual', 'evaluar', 'avanzado', 1.4, 4.0,
 ARRAY['perspective_comparison', 'multi_viewpoint_analysis'], get_test_text(1)),
...
('CL-26', 'Evaluación de relevancia de información', 
 ...
 ARRAY['relevance_evaluation', 'information_filtering'], get_test_text(1)),
...
('CL-27', 'Análisis de estructura argumentativa', 
 ...
 ARRAY['evaluar-reflexionar', 'interpretar-relacionar'], 
 'contemporáneo', 'universal', 'textual', 'analizar', 'avanzado', 1.4, 3.8,
 ARRAY['argumentative_structure_analysis', 'logical_organization'], get_test_text(1)),
...
('CL-28', 'Evaluación de objetividad vs subjetividad', 
 ...
 ARRAY['objectivity_evaluation', 'fact_opinion_distinction'], get_test_text(1)),
...
('CL-29', 'Análisis de implicaciones sociales', 
 ...
 ARRAY['analizar-sintetizar', 'interpretar-relacionar'], 
 'contemporáneo', 'universal', 'textual', 'evaluar', 'avanzado', 1.5, 4.2,
 ARRAY['social_implication_analysis', 'ethical_evaluation'], get_test_text(1)),
...
('CL-30', 'Síntesis crítica de múltiples textos', 
 ...
 ARRAY['critical_synthesis', 'multi_source_integration'], get_test_text(1))
...
-- Verificar que los skill_id se asignaron correctamente
SELECT
    'Skills y Tests asignados correctamente' as verificacion,
    COUNT(*) as total_con_skill_id,
...
-- Mostrar algunos ejemplos de skill_id y test_id
SELECT
    code,
    title,
    skill_id,
...
SELECT 'Sistema sin FK - skill_id y test_id como TEXT estables' as conversion;
SELECT 'Sin errores de claves foráneas o UUIDs problemáticos' as estado;

-- =====================================================
-- FIN DEL SCRIPT - 30 NODOS DE COMPETENCIA LECTORA SIN FK
-- =====================================================