-- =====================================================
-- IMPLEMENTACIÓN COMPLETA DE NODOS DE COMPETENCIA LECTORA
-- 30 nodos especializados en comprensión y análisis textual
...
-- PASO 2: Insertar nodos de Competencia Lectora - Comprensión Literal (10 nodos)
...
('CL-03', 'Secuenciación de eventos narrativos', 
 ...
 ARRAY['sequence_ordering', 'chronological_analysis'], 1),
...
('CL-04', 'Identificación de personajes y roles', 
 ...
 ARRAY['character_identification', 'role_analysis'], 1),
...
('CL-05', 'Comprensión de relaciones causales explícitas', 
 ...
 ARRAY['causal_relationship_analysis', 'logical_connections'], 1),
...
('CL-06', 'Localización de datos específicos', 
 ...
 ARRAY['data_location', 'specific_information'], 1),
...
('CL-07', 'Identificación de definiciones y conceptos', 
 ...
 ARRAY['definition_identification', 'concept_recognition'], 1),
...
('CL-08', 'Comprensión de instrucciones y procedimientos', 
 ...
 ARRAY['procedural_comprehension', 'instruction_following'], 1),
...
('CL-09', 'Identificación de ejemplos y casos', 
 ...
 ARRAY['interpretar-relacionar', 'analizar-sintetizar'], 
 'contemporáneo', 'universal', 'textual', 'comprender', 'básico', 1.0, 2.2,
 ARRAY['example_identification', 'illustration_recognition'], 1),
...
('CL-10', 'Comprensión de descripciones detalladas', 
 ...
 ARRAY['descriptive_comprehension', 'detail_analysis'], 1);

-- PASO 3: Insertar nodos de Competencia Lectora - Comprensión Inferencial (10 nodos)
INSERT INTO learning_nodes (
    code, name, description, subject, primary_skill, secondary_skills,
    historical_period, geographical_scope, thematic_area, bloom_level, 
    difficulty, weight, average_time_minutes, question_types, test_id
...
('CL-11', 'Inferencia de información implícita', 
 ...
 ARRAY['implicit_inference', 'deductive_reasoning'], 1),
...
('CL-12', 'Deducción de motivaciones de personajes', 
 ...
 ARRAY['character_motivation_analysis', 'psychological_inference'], 1),
...
('CL-15', 'Deducción del significado contextual', 
 ...
 ARRAY['localizar-informacion', 'analizar-sintetizar'], 
 'contemporáneo', 'universal', 'textual', 'comprender', 'intermedio', 1.2, 2.8,
 ARRAY['contextual_meaning_inference', 'vocabulary_deduction'], 1),

('CL-16', 'Inferencia de propósito comunicativo', 
 'Deduce la intención del autor al escribir el texto', 
 'COMPETENCIA_LECTORA', 'evaluar-reflexionar', 
 ARRAY['interpretar-relacionar', 'analizar-sintetizar'], 
 'contemporáneo', 'universal', 'textual', 'evaluar', 'avanzado', 1.5, 4.0,
 ARRAY['communicative_purpose_analysis', 'authorial_intent'], 1),
...
('CL-17', 'Deducción de audiencia objetivo', 
 ...
 ARRAY['target_audience_analysis', 'reader_identification'], 1),
...
('CL-18', 'Inferencia de tono y atmósfera', 
 ...
 ARRAY['tone_analysis', 'atmospheric_inference'], 1),
...
('CL-19', 'Deducción de consecuencias implícitas', 
 ...
 ARRAY['consequence_inference', 'causal_projection'], 1),
...
('CL-20', 'Inferencia de información faltante', 
 ...
 ARRAY['gap_filling_inference', 'missing_information_deduction'], 1);

-- PASO 4: Insertar nodos de Competencia Lectora - Análisis Crítico (10 nodos)
INSERT INTO learning_nodes (
    code, name, description, subject, primary_skill, secondary_skills,
    historical_period, geographical_scope, thematic_area, bloom_level, 
    difficulty, weight, average_time_minutes, question_types, test_id
...
('CL-21', 'Evaluación de credibilidad de fuentes', 
 ...
 ARRAY['source_credibility_evaluation', 'authority_analysis'], 1),
...
('CL-22', 'Identificación de sesgos y perspectivas', 
 ...
 ARRAY['bias_identification', 'perspective_analysis'], 1),
...
('CL-23', 'Análisis de argumentos y evidencias', 
 ...
 ARRAY['argument_analysis', 'evidence_evaluation'], 1),
...
('CL-24', 'Detección de falacias lógicas', 
 ...
 ARRAY['analizar-sintetizar', 'interpretar-relacionar'], 
 'contemporáneo', 'universal', 'textual', 'evaluar', 'avanzado', 1.5, 4.2,
 ARRAY['logical_fallacy_detection', 'reasoning_error_analysis'], 1),
...
('CL-25', 'Comparación de múltiples perspectivas', 
 ...
 'contemporáneo', 'universal', 'textual', 'evaluar', 'avanzado', 1.4, 4.0,
 ARRAY['perspective_comparison', 'multi_viewpoint_analysis'], 1),
...
('CL-26', 'Evaluación de relevancia de información', 
 ...
 ARRAY['relevance_evaluation', 'information_filtering'], 1),
...
('CL-27', 'Análisis de estructura argumentativa', 
 ...
 ARRAY['evaluar-reflexionar', 'interpretar-relacionar'], 
 'contemporáneo', 'universal', 'textual', 'analizar', 'avanzado', 1.4, 3.8,
 ARRAY['argumentative_structure_analysis', 'logical_organization'], 1),
...
('CL-28', 'Evaluación de objetividad vs subjetividad', 
 ...
 ARRAY['objectivity_evaluation', 'fact_opinion_distinction'], 1),
...
('CL-29', 'Análisis de implicaciones sociales', 
 ...
 ARRAY['analizar-sintetizar', 'interpretar-relacionar'], 
 'contemporáneo', 'universal', 'textual', 'evaluar', 'avanzado', 1.5, 4.2,
 ARRAY['social_implication_analysis', 'ethical_evaluation'], 1),
...
SELECT 
    bloom_level,
    COUNT(*) as cantidad,
    ROUND(AVG(difficulty::numeric), 2) as dificultad_promedio
FROM learning_nodes 
WHERE subject = 'COMPETENCIA_LECTORA'
...
SELECT 
    'IMPLEMENTACIÓN COMPLETA DE NODOS DE COMPETENCIA LECTORA' as resultado,
...
SELECT 
    '- ' || COUNT(CASE WHEN code LIKE 'CL-0%' AND code <= 'CL-10' THEN 1 END) || ' nodos de Comprensión Literal (CL-01 a CL-10)' as literal_nodos
FROM learning_nodes WHERE subject = 'COMPETENCIA_LECTORA'
UNION ALL
SELECT 
    '- ' || COUNT(CASE WHEN code LIKE 'CL-1%' AND code >= 'CL-11' AND code <= 'CL-20' THEN 1 END) || ' nodos de Comprensión Inferencial (CL-11 a CL-20)' as inferencial_nodos
FROM learning_nodes WHERE subject = 'COMPETENCIA_LECTORA'
UNION ALL
SELECT 
    '- ' || COUNT(CASE WHEN code LIKE 'CL-2%' AND code >= 'CL-21' THEN 1 END) || ' nodos de Análisis Crítico (CL-21 a CL-30)' as critico_nodos
FROM learning_nodes WHERE subject = 'COMPETENCIA_LECTORA';

-- =====================================================
-- FIN DEL SCRIPT - 30 NODOS DE COMPETENCIA LECTORA IMPLEMENTADOS
-- =====================================================