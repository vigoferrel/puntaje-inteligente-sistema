...
/**
 * Calculadora de mÃ©tricas institucionales
 * Responsabilidad Ãºnica: cÃ¡lculos de mÃ©tricas
 */
...
export class MetricsCalculator {
  /**
   * Calcula mÃ©tricas institucionales basadas en datos de estudiantes
   */
  static calculateInstitutionalMetrics(
    ...
    try {
      ...
      logger.error('MetricsCalculator', 'Error calculando mÃ©tricas institucionales', error);
      throw error;
    }
  }
  ...
  private static calculateEngagement(exercises: unknown[]): number {
  ...
  private static calculateProgress(progress: unknown[]): number {
  ...
  private static calculateSubjectPerformance(progress: unknown[]): Record<string, number> {
  ...
  private static calculateToolUsage(exercises: unknown[]): Record<string, number> {
