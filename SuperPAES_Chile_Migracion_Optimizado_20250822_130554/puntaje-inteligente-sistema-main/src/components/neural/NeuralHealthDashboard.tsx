...
export const NeuralHealthDashboard: FC = () => {
  const [metrics, setMetrics] = useState<NeuralHealthMetrics>({
    systemHealth: 98,
    errorRate: 0.1,
    responseTime: 120,
    memoryUsage: 45,
        ...
        <CardContent>
          <div className="flex items-center justify-between mb-4">
            ...
            <Badge className={
              ...
              {overallHealth > 95 ? 'Ã“ptimo' : 
               overallHealth > 80 ? 'Bueno' : 'CrÃ­tico'}
            </Badge>
          </div>
          <Progress value={overallHealth} className="h-3" />
          <div className="text-sm text-white/70 mt-2">
            Sistema funcionando en condiciones {overallHealth > 95 ? 'Ã³ptimas' : overallHealth > 80 ? 'normales' : 'subÃ³ptimas'}
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <div className="space-y-2">
            <div className="flex items-center gap-2 text-green-400">
              ...
              <span className="text-sm">Protocolos de auto-recuperaciÃ³n activados</span>
            </div>
            <div className="flex items-center gap-2 text-green-400">
              <CheckCircle className="w-4 h-4" />
            ...
            <div className="flex items-center gap-2 text-blue-400">
              ...
              <span className="text-sm">Monitoreo continuo de salud sistÃ©mica</span>
            </div>
          </div>
        </CardContent>
      </Card>
