...
export const IntelligentChatAssistant: React.FC<ChatAssistantProps> = ({
  ...
  const getSessionTypeIcon = () => {
    switch (sessionType) {
      ...
      case 'lecture_guide': return 'ðŸ”';
      case 'paes_coach': return 'ðŸŽ¯';
      case 'career_counselor': return 'ðŸŽ“';
      default: return 'ðŸ¤–';
    }
  };
  ...
  const getSessionTypeName = () => {
    switch (sessionType) {
      ...
      case 'lecture_guide': return 'LectoGuÃ­a IA';
    ...
    >
      <Card className="h-full bg-black/90 backdrop-blur-xl border-gray-700 shadow-2xl">
        <CardHeader className="pb-3">
          ...
          {/* MÃ©tricas neurales en tiempo real */}
