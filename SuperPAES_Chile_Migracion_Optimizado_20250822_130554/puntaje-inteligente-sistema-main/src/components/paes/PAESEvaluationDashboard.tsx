...
export const PAESEvaluationDashboard: React.FC<PAESEvaluationDashboardProps> = ({
  onStartDiagnostic,
  onViewResults,
  onScheduleTest
}) => {
  ...
  const subjectScores = [
    { subject: "ComprensiÃ³n Lectora", current: 680, target: 720, progress: 85 },
    { subject: "MatemÃ¡tica M1", current: 590, target: 650, progress: 72 },
    { subject: "MatemÃ¡tica M2", current: 610, target: 680, progress: 68 },
  ...
  const recommendations = [
    {
      priority: "high",
      title: "Reforzar MatemÃ¡tica M1",
      description: "EnfÃ³cate en Ã¡lgebra y funciones para mejorar 60 puntos",
      estimatedGain: 60
    },
    {
      priority: "medium",
      title: "Optimizar tiempo en Ciencias",
      description: "Mejora la velocidad de resoluciÃ³n en quÃ­mica",
      estimatedGain: 35
    },
    {
      priority: "low",
      title: "Mantener nivel en Historia",
      description: "ContinÃºa con ejercicios de repaso regulares",
      estimatedGain: 20
    }
  ];
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium">PrÃ³ximo Test</span>
            </div>
            <div className="text-2xl font-bold">{evaluationStats.nextTest}</div>
            <div className="text-sm text-muted-foreground">DiagnÃ³stico programado</div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium">PreparaciÃ³n</span>
            </div>
      ...
      {activeTab === 'schedule' && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>PrÃ³ximas evaluaciones y diagnÃ³sticos</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Button onClick={onStartDiagnostic} className="h-16 gap-3">
          ...
          <div className="text-left">
            <div className="font-medium">Iniciar DiagnÃ³stico</div>
            <div className="text-xs opacity-80">EvaluaciÃ³n adaptativa</div>
          </div>
        </Button>
        ...
        <Button variant="outline" onClick={onViewResults} className="h-16 gap-3">
          ...
          <div className="text-left">
            ...
            <div className="text-xs opacity-80">AnÃ¡lisis detallado</div>
          </div>
        </Button>
        ...
        <Button variant="outline" onClick={onScheduleTest} className="h-16 gap-3">
          ...
          <div className="text-left">
            ...
            <div className="text-xs opacity-80">Planificar evaluaciÃ³n</div>
          </div>
        </Button>
      </div>
    </div>
