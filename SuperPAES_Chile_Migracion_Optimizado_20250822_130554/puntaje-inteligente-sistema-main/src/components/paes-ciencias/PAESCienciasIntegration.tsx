    ...
    return (
      <Card className="bg-gray-800 border-gray-700">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-gray-300">Cargando integraciÃ³n PAES Ciencias...</p>
        </CardContent>
      </Card>
    );
  }
    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <Card className="bg-gray-800 border-gray-700">
            <CardHeader>
              <CardTitle className="text-white">DistribuciÃ³n por Ãreas de Conocimiento</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {['CS-BIO', 'CS-FIS', 'CS-QUIM', 'CS-MET'].map((prefix, index) => {
                  ...
                  const areaName = prefix === 'CS-BIO' ? 'BiologÃ­a' :
                                 prefix === 'CS-FIS' ? 'FÃ­sica' :
                                 prefix === 'CS-QUIM' ? 'QuÃ­mica' : 'MetodologÃ­a';
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {['bÃ¡sico', 'intermedio', 'avanzado'].map(difficulty => {
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                  <div className="bg-gray-700/50 rounded-lg p-3">
                    <div className="text-sm text-gray-400">MÃ³dulo ComÃºn</div>
                  ...
                  <div className="bg-gray-700/50 rounded-lg p-3">
                    <div className="text-sm text-gray-400">Electivo BiologÃ­a</div>
                    <div className="text-lg font-bold text-white">
                      {questionMappings.filter(q => q.questionNumber > 54).length}
                    </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-xs text-gray-500">
                            {node.domain_category} â€¢ {node.cognitive_level}
                          </div>
                        </div>
                      </div>
                    </motion.div>
        ...
        <TabsContent value="analytics" className="space-y-6">
          {analytics ? (
            <>
              <Card className="bg-gray-800 border-gray-700">
                <CardHeader>
                  <CardTitle className="text-white">DistribuciÃ³n de Habilidades</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="bg-gray-800 border-gray-700">
                <CardHeader>
                  <CardTitle className="text-white">Nodos CrÃ­ticos</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                      ...
                      <div key={index} className="flex justify-between items-center p-3 bg-gray-700/50 rounded-lg">
                        <div className="flex-1">
                          ...
                          <div className="text-sm text-gray-400">
                            {node.cognitive_level} â€¢ {node.difficulty}
                          </div>
                        </div>
                        <div className="text-right">
