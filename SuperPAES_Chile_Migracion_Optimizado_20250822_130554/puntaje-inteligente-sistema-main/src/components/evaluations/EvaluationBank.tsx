...
export const EvaluationBank: React.FC = () => {
  ...
  const evaluationCategories = [
    {
      ...
      evaluations: 156,
      difficulty: 'Variada',
      description: 'ComprensiÃ³n de textos y anÃ¡lisis crÃ­tico'
    },
    {
      id: 'matematica',
      name: 'MatemÃ¡tica M1 y M2',
      icon: Target,
      color: 'bg-green-600',
      evaluations: 243,
      difficulty: 'Progresiva',
      description: 'Desde Ã¡lgebra bÃ¡sica hasta cÃ¡lculo avanzado'
    },
    {
      id: 'ciencias',
      name: 'Ciencias',
      ...
      description: 'FÃ­sica, quÃ­mica y biologÃ­a integradas'
    },
    {
      id: 'historia',
  ...
  const featuredEvaluations = [
    ...
    {
      id: 2,
      title: 'ComprensiÃ³n Lectora Intensiva',
    ...
    {
      id: 3,
      title: 'MatemÃ¡tica M1 - Ãlgebra Avanzada',
      subject: 'MatemÃ¡tica',
      questions: 30,
      duration: '75min',
      difficulty: 'Avanzado',
