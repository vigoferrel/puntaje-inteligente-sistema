...
export const AdvancedFloatingNavigation: React.FC = () => {
  ...
  const handleNavigation = (route: string) => {
    console.log(`Ã°Å¸Å½Â¬ NavegaciÃƒÂ³n cinematogrÃƒÂ¡fica avanzada: ${route}`);
    navigate(route);
    setIsExpanded(false);
    
    // Efecto de sonido si estÃƒÂ¡ habilitado
    if (audioEnabled) {
      playNavigationSound();
    }
  };
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
        ...
        {isExpanded && (
          ...
          >
              ...
              >
                ...
                <div className="space-y-2 text-xs">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-blue-400">Ãƒâ€œptimo</span>
                  </div>
                  <div className="flex justify-between">
            ...
            >
              ...
              {/* Selector de Modo CinematogrÃƒÂ¡fico */}
      ...
      {Array.from({ length: 3 }).map((_, i) => (
        <motion.div
          key={i}
          className="absolute inset-0 rounded-full border-2 dynamic-border dynamic-border-mode"
