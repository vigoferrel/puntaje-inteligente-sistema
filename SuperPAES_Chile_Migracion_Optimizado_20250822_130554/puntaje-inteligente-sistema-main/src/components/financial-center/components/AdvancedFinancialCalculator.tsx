...
export const AdvancedFinancialCalculator: React.FC = () => {
  ...
  const calculateScholarships = () => {
    ...
    if (profile.paesScore >= 750) {
      results.push({
        ...
        requirements: 'Puntaje PAES â‰¥ 750',
        probability: 95
      });
      ...
      results.push({
        ...
        requirements: 'Puntaje PAES â‰¥ 700 + ranking escolar',
        probability: 85
      });
      ...
      results.push({
        ...
        requirements: 'Puntaje PAES â‰¥ 650',
        probability: 70
      });
    }

    // Becas por necesidad socioeconÃ³mica
    if (profile.familyIncome <= 500000) {
      results.push({
        ...
        coverage: 100,
        amount: profile.expectedTuition,
        requirements: 'Ingresos familiares â‰¤ $500.000',
        probability: 90
      });
    ...
    if (profile.careerType === 'stem') {
      results.push({
        name: 'Beca VocaciÃ³n CientÃ­fica',
        type: 'merit',
        coverage: 40,
  ...
  const calculateProjection = (scholarshipResults: ScholarshipResult[]) => {
    ...
    // Calcular financiamiento (CAE o crÃ©dito universitario)
    const interestRate = 0.04; // 4% anual
    const years = 6; // 6 aÃ±os de pago tÃ­pico
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-cyan-200">
          AnÃ¡lisis predictivo de becas y financiamiento universitario
        </p>
      </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <Select value={profile.region} onValueChange={(value) => setProfile(prev => ({ ...prev, region: value }))}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="araucania">AraucanÃ­a</SelectItem>
                  ...
                  <div>
                    ...
                    <Select value={profile.careerType} onValueChange={(value) => setProfile(prev => ({ ...prev, careerType: value }))}>
                      ...
                      <SelectContent>
                        <SelectItem value="stem">STEM (Ciencias/TecnologÃ­a)</SelectItem>
