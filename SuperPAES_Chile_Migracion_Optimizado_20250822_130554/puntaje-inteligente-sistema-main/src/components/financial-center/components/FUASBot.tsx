...
export const FUASBot: React.FC = () => {
  ...
  const [messages, setMessages] = useState([
    {
      type: 'bot',
      content: 'Â¡Hola! Soy tu asistente FUAS. Â¿En quÃ© puedo ayudarte hoy?',
      timestamp: new Date()
    }
  ]);
  ...
  const quickActions = [
    { text: 'Fechas crÃ­ticas FUAS', icon: Clock },
  ...
  const handleQuickAction = (action: string) => {
    const responses: Record<string, string> = {
      'Fechas crÃ­ticas FUAS': 'ðŸ“… FECHAS CRÃTICAS:\nâ€¢ Cierre FUAS: 13 marzo 2025 (14:00 hrs)\nâ€¢ VerificaciÃ³n RSH: 21 abril 2025\nâ€¢ AsignaciÃ³n final: 28 mayo 2025',
      'Calcular elegibilidad': 'ðŸŽ¯ Para calcular tu elegibilidad necesito:\nâ€¢ Puntajes PAES\nâ€¢ Decil socioeconÃ³mico\nâ€¢ Tipo de establecimiento\nÂ¿Comenzamos?',
      'Documentos necesarios': 'ðŸ“‹ DOCUMENTOS FUAS:\nâ€¢ CÃ©dula de identidad\nâ€¢ Certificado notas enseÃ±anza media\nâ€¢ InformaciÃ³n familiar actualizada\nâ€¢ Situaciones especiales (si aplica)',
      'Optimizar estrategia': 'ðŸš€ ESTRATEGIA Ã“PTIMA:\n1. Completa FUAS cuanto antes\n2. Verifica adscripciÃ³n instituciones\n3. Maximiza puntajes antes de marzo\n4. Prepara documentaciÃ³n'
    };

    setMessages(prev => [...prev, 
      { type: 'user', content: action, timestamp: new Date() },
      { type: 'bot', content: responses[action] || 'InformaciÃ³n no disponible', timestamp: new Date() }
    ]);
  };
              ...
              <div className="p-3 border-t border-cyan-500/30">
                ...
                <div className="flex space-x-2">
                  <input
                    ...
                    placeholder="PregÃºntame sobre FUAS..."
