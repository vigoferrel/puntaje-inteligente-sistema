      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">Centro Financiero CinematogrÃ¡fico</h1>
              <p className="text-cyan-200">Sistema neural de optimizaciÃ³n financiera PAES 2025</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Badge className="bg-orange-500/20 text-orange-400 border-orange-500/30">
              ...
              {financialMetrics.daysToDeadline.toFixed(0)} dÃ­as FUAS
            </Badge>
          </div>
        </div>
      </motion.div>
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-lg p-4 border border-purple-400/30">
                      ...
                      <div className="text-purple-300 text-sm">OptimizaciÃ³n IA</div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-lg p-4 border border-orange-400/30">
                      ...
                      <div className="text-orange-300 text-sm">DÃ­as Restantes</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
