...
const sections = [
  {
    ...
    description: 'Calcula becas disponibles segÃºn tu puntaje PAES proyectado'
  },
  {
    id: 'simulator',
    ...
    description: 'Simula costos totales de carrera segÃºn puntaje y universidad'
  },
  {
    id: 'predictor',
    ...
    description: 'AnÃ¡lisis predictivo de ROI educacional y opciones vocacionales'
  }
];
