...
export const PAESFinancialCalculator: React.FC = () => {
  ...
  const calculateFinancialScenario = () => {
    ...
    // Calcular costo total despuÃ©s de beca
    ...
    const monthlyPayment = totalCost / 60; // 5 aÃ±os de pago
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  {calculationResults.scholarshipEligible 
                    ? 'Elegible para beca de excelencia acadÃ©mica'
                    : 'No elegible para beca (puntaje mÃ­nimo: 650)'}
                </p>
              </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              <h4 className="font-bold text-xl">
                {Math.round(calculationResults.yearsToPayOff)} aÃ±os
              </h4>
          ...
          <div className="space-y-3">
            {scenario.paesScore < 650 && (
              <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                ...
                <p className="text-sm text-yellow-700">
                  Aumentar tu puntaje a 650+ te harÃ­a elegible para becas de excelencia acadÃ©mica.
                </p>
              </div>
            )}
            ...
            {scenario.paesScore >= 650 && scenario.paesScore < 700 && (
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <p className="text-sm text-blue-700">
                  Alcanzar 700+ puntos incrementarÃ­a tu beca al 60% del arancel.
                </p>
              </div>
            )}
            ...
            {scenario.paesScore >= 700 && scenario.paesScore < 750 && (
              <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                <h4 className="font-medium text-green-800">Beca mÃ¡xima disponible</h4>
                <p className="text-sm text-green-700">
                  Con 750+ puntos accederÃ­as a la beca mÃ¡xima del 80%.
                </p>
              </div>
            )}
          </div>
