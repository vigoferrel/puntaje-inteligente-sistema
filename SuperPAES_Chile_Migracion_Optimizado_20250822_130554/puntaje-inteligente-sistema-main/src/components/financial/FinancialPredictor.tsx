        ...
        <CardContent className="space-y-4">
          <div className="text-center">
            <p className="text-white/80 mb-4">
              AnÃ¡lisis predictivo basado en tu perfil acadÃ©mico, tendencias del mercado laboral y datos histÃ³ricos
            </p>
            <Button 
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          <span className="text-white/70">InversiÃ³n total:</span>
                        ...
                        <div className="flex justify-between">
                          <span className="text-white/70">RecuperaciÃ³n:</span>
                          <span className="text-blue-400">{data.paybackYears} aÃ±os</span>
                        </div>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="text-center">
                  ...
                  <div className="text-white/70 text-sm">TecnologÃ­a</div>
                </div>
                <div className="text-center">
