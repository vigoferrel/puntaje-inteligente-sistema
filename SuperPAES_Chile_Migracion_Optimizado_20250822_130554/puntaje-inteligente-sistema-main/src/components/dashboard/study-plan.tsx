...
export const StudyPlan = () => {
      ...
      <Card>
        ...
        <CardContent className="flex flex-col items-center justify-center py-8 text-center">
          ...
          <p className="mb-6 text-muted-foreground max-w-md">
            AÃºn no tienes un plan de estudio creado. Haz clic en el botÃ³n para crear uno personalizado.
          </p>
  ...
  // Helper (...args: unknown[]) => unknown to get color scheme by index
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          {currentPlan.description || "Basado en tu diagnÃ³stico y objetivos de aprendizaje"}
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-6">
          ...
          <div className="rounded-lg border p-4 mb-4">
            ...
            <div className="grid grid-cols-3 gap-2 text-xs text-muted-foreground mt-2">
              ...
              <div className="flex items-center">
                ...
                <span>
                  {nextNode ? "ContinÃºa aprendiendo" : "Â¡Plan completado!"}
                </span>
              </div>
            </div>
          </div>
          ...
          {nextNode ? (
            <div className="bg-primary/5 rounded-lg p-4 mb-4 border border-primary/20">
              ...
              <p className="text-sm text-muted-foreground mt-1 mb-3">
                {nextNode.nodeName || `MÃ³dulo ${nextNode.position}`}
              </p>
              <Button 
                size="sm" 
            ...
            <div className="bg-green-50 rounded-lg p-4 mb-4 border border-green-200">
              ...
              <p className="text-sm text-green-600/80 mt-1 mb-3">
                Has completado todos los mÃ³dulos de este plan.
              </p>
              <Button 
                size="sm" 
                variant="outline"
                  ...
                  <Card className={`${colors.bg} border`} key={node.id}>
                    <CardContent className="p-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-600">{node.nodeName || `MÃ³dulo ${index + 1}`}</p>
                        
                        <div className="h-1.5 w-full bg-white rounded-full overflow-hidden">
                          <div
                            className="h-full bg-current rounded-full dynamic-progress-bar"
                            data-width={nodeProgress}
                            data-color={nodeProgress === 100 ? '#10b981' : '#6366f1'}
                          />
                        </div>
              ...
              [1, 2, 3].map((i) => (
                <Card key={i} className="bg-gradient-to-br from-gray-50 to-gray-100 border-gray-200">
                  <CardContent className="p-4">
                    ...
                    <p className="text-sm text-gray-600 mt-1">MÃ³dulo pendiente</p>
