...
export const ParentModernDashboard: FC = () => {
      ...
      <div className="p-6">
        <Card className="border-red-200 bg-red-50">
          <CardContent className="p-6 text-center">
            ...
            <h3 className="text-lg font-semibold text-red-800 mb-1">Error de ConexiÃ³n</h3>
              ...
              <div key={child.id} className="p-3 bg-amber-50 rounded-lg border border-amber-200">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-sm text-amber-700">
                      {metrics?.overallProgress && metrics.overallProgress < 30
                        ? "Necesita mÃ¡s tiempo de estudio diario"
                        : metrics?.streakDays === 0
                  ...
                  <Badge variant="outline" className="text-amber-700 border-amber-300">
                    {metrics?.overallProgress && metrics.overallProgress < 30 ? "AtenciÃ³n" : "Normal"}
                  </Badge>
                </div>
              </div>
            ))}
