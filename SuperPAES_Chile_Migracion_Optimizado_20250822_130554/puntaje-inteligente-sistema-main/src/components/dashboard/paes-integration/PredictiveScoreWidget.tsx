...
export const PredictiveScoreWidget: FC<PredictiveScoreWidgetProps> = ({
  predictedScore,
  confidence,
  strengths,
  weaknesses,
        ...
        <CardContent>
          <div className="text-center text-orange-700">
            ...
            <p className="text-sm">
              ...
              para generar una predicciÃ³n confiable.
            </p>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <span className="text-sm text-blue-700">Confianza del anÃ¡lisis</span>
          ...
          <div className="bg-white p-3 rounded-lg border border-blue-200">
            <div className="flex items-start gap-2">
              ...
              <div>
                <h4 className="text-sm font-medium text-blue-800">RecomendaciÃ³n</h4>
