...
export const WelcomeTour = ({ userName, onComplete }: WelcomeTourProps) => {
  ...
  const tourSteps = [
    {
      title: `Â¡Bienvenido a PAES PRO${userName ? ', ' + userName : ''}!`,
      description: "Te guiaremos a travÃ©s de las principales caracterÃ­sticas de la plataforma.",
      icon: <HelpCircle className="h-8 w-8 text-primary" />
    },
    {
      title: "Dashboard Personalizado",
      description: "AquÃ­ podrÃ¡s ver tu progreso, estadÃ­sticas y acceder rÃ¡pidamente a todas las funcionalidades.",
      icon: <CheckCircle className="h-8 w-8 text-stp-success" />
    },
    {
      title: "DiagnÃ³stico",
      description: "Realiza un diagnÃ³stico para evaluar tus conocimientos y recibir un plan personalizado.",
      icon: <BookOpen className="h-8 w-8 text-stp-info" />
    },
    {
      title: "LectoGuÃ­a AI",
      description: "Utiliza nuestra IA para practicar comprensiÃ³n lectora con ejercicios personalizados.",
