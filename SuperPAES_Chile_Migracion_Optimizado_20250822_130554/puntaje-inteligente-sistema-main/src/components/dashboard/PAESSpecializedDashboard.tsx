...
export const PAESSpecializedDashboard: React.FC<PAESSpecializedDashboardProps> = ({ 
  ...
  const [evaluationStats, setEvaluationStats] = useState<unknown>(null);
  const [subjectScores, setSubjectScores] = useState<unknown[]>([]);
  const [upcomingTests, setUpcomingTests] = useState<unknown[]>([]);
              ...
              <Card className="bg-gray-800 border-gray-700">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div>
                      <h4 className="font-medium text-white mb-3">Gaps CrÃ­ticos de Habilidades</h4>
        ...
        <Card className="bg-gray-800 border-gray-700">
          <CardContent className="p-8 text-center">
            <div className="text-gray-400">
              Vista especÃ­fica para {activeTest.testName} en desarrollo
            </div>
          </CardContent>
        </Card>
      );
        ...
        <Card className="bg-white/10 border-white/20">
          <CardContent className="p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium text-white">PrÃ³ximo Test</span>
            </div>
            <div className="text-2xl font-bold text-white">
        ...
        <Card className="bg-white/10 border-white/20">
          <CardContent className="p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium text-white">PreparaciÃ³n</span>
            </div>
            <div className="text-2xl font-bold text-white">
            ...
            {upcomingTests.length > 0 ? upcomingTests.map((test, index) => (
              <div key={index} className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                <div>
                  ...
                  <div className="text-sm text-gray-400">{test.date} â€¢ {test.duration}</div>
                </div>
      ...
      <Card className="bg-white/10 border-white/20">
        <CardContent className="p-8 text-center">
          <div className="text-white">
            Modo Universo PAES - VisualizaciÃ³n 3D en desarrollo
          </div>
        </CardContent>
      </Card>
    </div>
    ...
    >
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-400">AnÃ¡lisis integral de tu preparaciÃ³n PAES</p>
        </div>
