...
export const OptimizedDashboard: FC = () => {
  const { user } = useAuth();
  ...
  const tools = [
    ...
    },
    {
      ...
      description: 'PlanificaciÃ³n personalizada con IA',
      icon: MapPin,
      path: '/plan',
    ...
    },
    {
      ...
      description: 'GarantÃ­a de excelencia educativa',
      icon: Shield,
      path: '/calidad',
    ...
    },
    {
      id: 'lectoguia',
      title: 'LectoGuÃ­a IA',
      description: 'Sistema de comprensiÃ³n lectora con IA',
      icon: BookOpen,
      path: '/lectoguia',
    ...
    },
    {
      ...
      description: 'Sistema de evaluaciÃ³n adaptativa',
      icon: Target,
      path: '/diagnostico',
    ...
    {
      id: 'calendario',
      title: 'Calendario CinematogrÃ¡fico',
      description: 'PlanificaciÃ³n de estudios inteligente',
      icon: Calendar,
      path: '/calendario',
    ...
    },
    {
      id: 'superpaes',
      title: 'SuperPAES',
      description: 'Sistema completo de preparaciÃ³n PAES',
      icon: Sparkles,
      path: '/superpaes',
    ...
    },
    {
      ...
      description: 'ExploraciÃ³n de datos y mÃ©tricas',
      icon: BarChart3,
      path: '/backend',
    ...
    },
    {
      ...
      description: 'GestiÃ³n y control de costos OpenRouter',
      icon: Settings,
      path: '/admin',
