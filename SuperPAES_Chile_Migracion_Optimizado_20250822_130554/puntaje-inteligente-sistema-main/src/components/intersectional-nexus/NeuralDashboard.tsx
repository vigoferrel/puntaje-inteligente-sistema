...
export const NeuralDashboard: FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* MÃ©tricas del Sistema Nervioso */}
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        ...
        <Card className="border-orange-200 bg-gradient-to-br from-orange-50 to-red-50">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-orange-700">ArmonÃ­a UX</p>
      ...
      {/* MÃ³dulos NeurolÃ³gicos Activos - Adaptado a strings */}
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              Red NeurolÃ³gica Activa ({activeModulesArray.length} mÃ³dulos)
            </CardTitle>
          </CardHeader>
          <CardContent>
            {activeModulesArray.length > 0 ? (
                ...
                {activeModulesArray.map((moduleId, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="font-medium">MÃ³dulo Neural</h4>
              ...
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p>No hay mÃ³dulos neurales activos</p>
              </div>
            )}
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-muted-foreground">MÃ³dulos Conectados</div>
              </div>
              <div className="text-center">
          ...
          <CardContent>
            ...
            <div className="mt-4 p-3 bg-gray-50 rounded-lg">
              <p className="text-sm text-muted-foreground">
                ...
                discreto sin interferir con el navegador. DelegaciÃ³n completa de privacidad 
