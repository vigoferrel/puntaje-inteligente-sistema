  ...
  useEffect(() => {
    const generateRealRecommendations = async () => {
      ...
      try {
        ...
        // AnÃ¡lisis de nodos con bajo rendimiento
        ...
        weakNodes.slice(0, 3).forEach((node, index) => {
          realRecs.push({
            ...
            description: `Tu nivel de dominio en "${node.learning_nodes?.title}" es del ${Math.round(node.mastery_level * 100)}%. Este nodo requiere atenciÃ³n inmediata.`,
            priority: 10 - index,
        ...
        // AnÃ¡lisis de oportunidades de crecimiento
        ...
        growthNodes.slice(0, 2).forEach((node, index) => {
          realRecs.push({
            ...
            description: `Tienes una base sÃ³lida (${Math.round(node.mastery_level * 100)}%) en "${node.learning_nodes?.title}". Es el momento perfecto para llevarlo al siguiente nivel.`,
            priority: 7 - index,
        ...
        if (strongNodes.length > 0) {
          realRecs.push({
            ...
            description: `Excelente dominio en ${strongNodes.length} Ã¡reas. Considera conectar estos conocimientos con nuevos conceptos.`,
            priority: 5,
            estimatedImpact: 'Medio',
            timeRequired: 20,
            actionType: 'connect',
      ...
      <CardContent className="space-y-4">
        ...
        {recommendations.length === 0 && (
          <div className="text-center py-8">
            ...
            <div className="text-white font-medium">Â¡Excelente trabajo!</div>
