...
export const PhaseNavigator: FC<PhaseNavigatorProps> = ({
  currentPhase,
  phaseProgress,
  onPhaseChange
}) => {
  const phases: { phase: TLearningCyclePhase; name: string; icon: string; description: string }[] = [
    {
      ...
      name: 'DiagnÃ³stico',
      icon: 'ðŸ”',
      description: 'EvalÃºa tu nivel actual'
    },
    {
      phase: 'SKILL_TRAINING',
      name: 'Entrenamiento',
      icon: 'ðŸ’ª',
      description: 'Desarrolla habilidades especÃ­ficas'
    },
    {
      phase: 'CONTENT_STUDY',
      name: 'Estudio',
      icon: 'ðŸ“š',
      description: 'Aprende contenidos teÃ³ricos'
    },
    {
