...
export const NeuralPAESCard: FC<NeuralPAESCardProps> = ({
  subject,
  index,
  onSelect,
  neuralState
  ...
  const getPriorityLevel = () => {
    ...
    if (neuralAvg >= 80) return { text: 'Ã“ptimo', color: 'bg-green-600/20 text-green-400' };
    if (neuralAvg >= 65) return { text: 'Bueno', color: 'bg-yellow-600/20 text-yellow-400' };
    return { text: 'CrÃ­tico', color: 'bg-red-600/20 text-red-400' };
  };
        ...
        <CardContent className="space-y-4 relative z-10">
          ...
          <div className="grid grid-cols-2 gap-2 text-center">
            ...
            <div className="bg-white/5 rounded-lg p-2">
              ...
              <div className="text-xs text-white/60">AdaptaciÃ³n</div>
            </div>
          </div>
