      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
            <h3 className="text-yellow-400 font-bold text-xl mb-2">ðŸŽ¯ Momentum</h3>
            <div className="text-3xl font-bold text-white mb-2">{achievementMomentum}%</div>
            <div className="w-full bg-white/20 rounded-full h-2">
              <div 
                className="bg-yellow-500 h-2 rounded-full transition-all duration-1000"
                className="dynamic-progress-fill" data-progress={achievementMomentum}
              />
            </div>
          </div>
          
          <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
            <h3 className="text-amber-400 font-bold text-xl mb-2">ðŸ… Total Logros</h3>
        ...
        {achievements.length > 0 && (
          <div>
            <h3 className="text-white font-bold text-2xl mb-4">ðŸŽŠ Logros Recientes</h3>
        ...
        <div>
          <h3 className="text-white font-bold text-2xl mb-4">ðŸ“Š Progreso por CategorÃ­a</h3>
