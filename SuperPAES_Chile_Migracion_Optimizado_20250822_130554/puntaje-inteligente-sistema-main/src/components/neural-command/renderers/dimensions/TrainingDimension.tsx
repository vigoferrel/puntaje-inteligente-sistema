...
export const TrainingDimension: FC = () => {
  return (
    <motion.div
      ...
      <div className="text-center space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          <div className="bg-white/10 rounded-lg p-6 backdrop-blur-sm">
            <h3 className="text-white font-bold text-xl mb-3">ðŸŽ¯ Entrenamiento Adaptativo</h3>
            <p className="text-white/70">
              Ejercicios que se ajustan automÃ¡ticamente a tu nivel y ritmo de aprendizaje.
            </p>
          </div>
          <div className="bg-white/10 rounded-lg p-6 backdrop-blur-sm">
            <h3 className="text-white font-bold text-xl mb-3">ðŸ“Š MÃ©tricas en Tiempo Real</h3>
            <p className="text-white/70">
