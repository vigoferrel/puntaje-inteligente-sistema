...
export const NeuralDimensionRenderer: FC<NeuralDimensionRendererProps> = ({
  activeDimension,
  selectedGalaxy,
  galaxies,
  neuralMetrics,
              ...
              <CardContent className="p-6">
                <div className="text-white">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold">AnÃ¡lisis Neural Avanzado</h3>
                      <p className="text-emerald-300">MÃ©tricas predictivas y anÃ¡lisis profundo</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    <div className="bg-emerald-500/20 p-4 rounded-lg">
                      ...
                      <div className="text-sm">PrecisiÃ³n Predictiva</div>
                    </div>
                ...
                <div className="text-white">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <div className="bg-violet-500/20 p-4 rounded-lg">
                      ...
                      <div className="text-sm">AdaptaciÃ³n IA</div>
                    </div>
                    ...
                    <div className="bg-indigo-500/20 p-4 rounded-lg">
                      ...
                      <div className="text-sm">DÃ­as Consecutivos</div>
                    </div>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="text-white">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold">AnÃ¡lisis Neural Avanzado</h3>
                      <p className="text-green-300">MÃ©tricas inteligentes de tu evoluciÃ³n</p>
                    </div>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="text-white">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold">PredicciÃ³n Vocacional IA</h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div className="bg-purple-500/20 p-4 rounded-lg">
                      <div className="text-lg font-bold text-purple-400">IngenierÃ­a</div>
