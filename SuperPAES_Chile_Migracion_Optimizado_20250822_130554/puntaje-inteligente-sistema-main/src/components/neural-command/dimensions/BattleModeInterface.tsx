          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              ...
              <div className="text-center p-3 bg-blue-500/20 rounded-xl">
                ...
                <div className="text-xs text-white/70">Tasa Ã‰xito</div>
              </div>
          ...
          {activeTab === 'tournaments' && (
            <Card className="bg-black/40 border-purple-500/30 backdrop-blur-xl">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">Torneos Ã‰picos</h3>
                <p className="text-white/70 mb-4">PrÃ³ximamente: Campeonatos por niveles con premios Ã©picos</p>
