...
export const AchievementEngine: React.FC<AchievementEngineProps> = ({
  ...
  const [achievements] = useState<Achievement[]>([
    ...
    },
    {
      ...
      requirements: ['10 dÃ­as consecutivos de estudio']
    },
    {
    ...
    },
    {
      ...
      description: 'ObtÃ©n 100% en 3 materias diferentes',
      category: 'mastery',
      rarity: 'legendary',
      icon: Crown,
      xpReward: 2000,
    ...
    },
    {
      ...
      description: 'Completa 5 nodos en menos de 1 dÃ­a',
      category: 'learning',
      rarity: 'rare',
      icon: Target,
      xpReward: 750,
      ...
      requirements: ['5 nodos en 1 dÃ­a']
    },
    {
      id: 'neural_champion',
      title: 'CampeÃ³n Neural',
  ...
  const categories = [
    ...
    { id: 'exploration', name: 'ExploraciÃ³n', icon: Star, count: achievements.filter(a => a.category === 'exploration').length },
    { id: 'mastery', name: 'MaestrÃ­a', icon: Crown, count: achievements.filter(a => a.category === 'mastery').length }
  ];
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-purple-200">Prestige {userLevel.prestige} â€¢ Neural Master</p>
              </div>
            </div>
          ...
          {activeTab === 'rewards' && (
            <Card className="bg-black/40 border-green-500/30 backdrop-blur-xl">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-white/70 mb-4">PrÃ³ximamente: Tienda de recompensas con items exclusivos</p>
