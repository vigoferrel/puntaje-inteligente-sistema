...
export const CinematicCalendar: React.FC = () => {
  ...
  const handleScheduleWorkflowItem = (item: unknown) => {
  ...
  useEffect(() => {
    if (showEventModal && quickEventType && !selectedEvent) {
      // El modal manejarÃ¡ automÃ¡ticamente el tipo preseleccionado
    }
            ...
            <CardHeader className="pb-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex space-x-2">
                  {['Mes', 'Semana', 'DÃ­a'].map((mode, index) => {
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center space-x-2 mt-2">
                              <Badge variant="outline" className="text-xs bg-white/10 border-white/20 text-white">
                                {event.all_day ? 'Todo el dÃ­a' : format(new Date(event.start_date), 'HH:mm')}
                              </Badge>
