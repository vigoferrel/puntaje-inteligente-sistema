    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <SelectContent className="premium-glass border-white/10">
                <SelectItem value="study_session">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-contrast-high">SesiÃ³n de Estudio</span>
                  </div>
                </SelectItem>
                ...
                <SelectItem value="deadline">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-contrast-high">Fecha LÃ­mite</span>
                  </div>
                </SelectItem>
          ...
          {/* Title */}
          <div className="space-y-2">
            <Label htmlFor="title" className="text-contrast-high font-medium">TÃ­tulo</Label>
            <Input
              id="title"
          ...
          {/* Description */}
          <div className="space-y-2">
            <Label htmlFor="description" className="text-contrast-high font-medium">DescripciÃ³n</Label>
            <Textarea
              id="description"
              ...
              <SelectContent className="premium-glass border-white/10">
                ...
                <SelectItem value="critical">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-contrast-high">CrÃ­tica</span>
                  </div>
                </SelectItem>
              </SelectContent>
            </Select>
          ...
          <div className="flex items-center space-x-3 p-3 premium-glass rounded-lg">
            ...
            />
            <Label htmlFor="all_day" className="text-contrast-high font-medium">Todo el dÃ­a</Label>
          </div>
          ...
          {/* Location */}
          <div className="space-y-2">
            <Label htmlFor="location" className="text-contrast-high font-medium">UbicaciÃ³n</Label>
            <Input
              id="location"
