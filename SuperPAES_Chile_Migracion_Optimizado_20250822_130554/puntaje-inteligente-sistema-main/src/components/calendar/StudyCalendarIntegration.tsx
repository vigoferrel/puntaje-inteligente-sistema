...
export const StudyCalendarIntegration: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const generateStudyEvents = () => {
      ...
      // Eventos para los prÃ³ximos 7 dÃ­as
      for (let i = 0; i < 7; i++) {
        const date = new Date(today);
        date.setDate(today.getDate() + i);
        
        // SesiÃ³n de ejercicios diaria
        events.push({
          id: `exercise-${i}`,
          title: 'PrÃ¡ctica de Ejercicios',
        ...
        // RevisiÃ³n de plan cada 3 dÃ­as
        if (i % 3 === 0) {
          events.push({
            id: `review-${i}`,
            title: 'RevisiÃ³n de Plan',
            subject: 'GENERAL',
            date,
            duration: 30,
            type: 'plan',
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          {event.duration} min â€¢ {event.subject}
                        </p>
                      </div>
                    </div>
                    {!event.completed && (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">
                      {event.date.toLocaleDateString()} â€¢ {event.duration} min
                    </p>
                  </div>
                </div>
