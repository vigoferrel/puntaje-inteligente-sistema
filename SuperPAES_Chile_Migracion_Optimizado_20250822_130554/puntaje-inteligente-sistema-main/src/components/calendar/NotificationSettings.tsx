      ...
      >
        <div className="flex items-center justify-between p-6 border-b border-gray-700">
          <div className="flex items-center space-x-2">
            ...
            <h2 className="text-xl font-semibold text-white">ConfiguraciÃ³n de Notificaciones</h2>
          </div>
          <Button
            variant="ghost"
            size="sm"
        ...
        <div className="p-6 space-y-6">
          <div>
            ...
            <Select value={selectedEventType} onValueChange={setSelectedEventType}>
              ...
              <SelectContent className="bg-gray-800 border-gray-600">
                ...
                <SelectItem value="deadline">Fechas LÃ­mite</SelectItem>
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-medium text-white flex items-center space-x-2">
              ...
              <span>MÃ©todos de NotificaciÃ³n</span>
            </h3>
            ...
            <div className="bg-gray-800/50 rounded-lg p-4 space-y-3">
              ...
              {localSettings.email_enabled && (
                <div className="text-sm text-gray-300">
                  RecibirÃ¡s notificaciones por email 15 minutos y 1 hora antes del evento.
                </div>
              )}
            </div>
            ...
            <div className="bg-gray-800/50 rounded-lg p-4 space-y-3">
              ...
              {localSettings.push_enabled && isSubscribed && (
                <div className="text-sm text-gray-300">
                  RecibirÃ¡s notificaciones push 15 minutos antes del evento.
                </div>
              )}
            </div>
            ...
            <div className="bg-gray-800/50 rounded-lg p-4 space-y-3">
              ...
              <div className="text-sm text-gray-400">
                Las notificaciones SMS estarÃ¡n disponibles prÃ³ximamente.
              </div>
            </div>
          </div>
