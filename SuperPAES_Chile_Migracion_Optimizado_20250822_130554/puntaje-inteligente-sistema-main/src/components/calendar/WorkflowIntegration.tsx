...
export const WorkflowIntegration: FC<WorkflowIntegrationProps> = ({ onScheduleItem }) => {
  // Simulamos datos del workflow actual del usuario
  const workflowItems: WorkflowItem[] = [
    {
      id: '1',
      title: 'Nodo: Funciones CuadrÃ¡ticas',
      type: 'node',
      status: 'pending',
      priority: 'high',
      estimatedTime: 45,
    ...
    {
      id: '2',
      title: 'Ejercicios: ComprensiÃ³n Lectora',
      type: 'exercise',
      status: 'in_progress',
      priority: 'medium',
      estimatedTime: 30,
    ...
    {
      id: '3',
      title: 'Plan Semanal: MatemÃ¡tica M2',
      type: 'plan',
      status: 'pending',
      priority: 'critical',
    ...
    <Card className="bg-gray-800/50 backdrop-blur-xl border-gray-700/50">
      <CardHeader className="pb-3">
        <CardTitle className="flex items-center space-x-2 text-white">
          ...
          <span>IntegraciÃ³n de Workflow</span>
        </CardTitle>
      </CardHeader>
              ...
              {item.progress !== undefined && item.progress > 0 && (
                <div className="mt-2">
                  <div className="w-full bg-gray-700 rounded-full h-1.5">
                    <div
                      className="bg-gradient-to-r from-cyan-500 to-blue-500 h-1.5 rounded-full transition-all duration-300 dynamic-progress-fill"
