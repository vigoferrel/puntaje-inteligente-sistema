...
export const PredictiveScoringPanel: FC<PredictiveScoringPanelProps> = ({
  predictedScores,
  currentScores,
  progressTrends,
  tests
  ...
  return (
    <div className="space-y-6">
            ...
            return (
              <div key={test.id} className="space-y-2">
                ...
                <div className="text-xs text-gray-500 flex justify-between">
                  ...
                  <span>{Math.round((predicted / 850) * 100)}% del mÃ¡ximo</span>
                </div>
              </div>
            );
          })}
      ...
      <Card>
        <CardHeader>
          <CardTitle>Factores de PredicciÃ³n</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <ul className="text-sm text-gray-600 space-y-1">
                <li>â€¢ Tendencia de mejora consistente</li>
                <li>â€¢ PrÃ¡ctica regular de ejercicios</li>
                <li>â€¢ ReducciÃ³n en tiempo de respuesta</li>
                <li>â€¢ Mejora en habilidades especÃ­ficas</li>
              </ul>
            </div>
            <div className="space-y-2">
              <h4 className="font-medium text-orange-700">Ãreas de AtenciÃ³n</h4>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>â€¢ Mantener constancia en el estudio</li>
                <li>â€¢ Reforzar Ã¡reas de menor rendimiento</li>
                <li>â€¢ Practicar ejercicios de mayor dificultad</li>
                <li>â€¢ Revisar conceptos fundamentales</li>
              </ul>
            </div>
          </div>
        </CardContent>
