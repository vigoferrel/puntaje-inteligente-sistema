    ...
    return (
      <Alert className="bg-blue-50 border-blue-200">
        ...
        <AlertDescription className="text-blue-700">
          No hay resultados para mostrar. Esto puede deberse a que el diagnÃ³stico no ha sido completado
    ...
    >
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className="grid grid-cols-3 mb-4">
          ...
          <TabsTrigger value="chart">GrÃ¡ficos</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="overview" className="space-y-4">
          ...
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardDescription>Tu desempeÃ±o general en el diagnÃ³stico</CardDescription>
            </CardHeader>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            >
              <Card>
                <CardHeader>
                  <CardTitle>Ãreas de mejora</CardTitle>
                  <CardDescription>Las habilidades que requieren mayor atenciÃ³n</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
        ...
        <TabsContent value="chart">
          <Card>
            <CardHeader>
              <CardTitle>VisualizaciÃ³n de resultados</CardTitle>
              <CardDescription>GrÃ¡fico comparativo de tus habilidades</CardDescription>
            </CardHeader>
            <CardContent>
              <motion.div 
                className="h-[400px]"
...
// FunciÃ³n auxiliar para mostrar nombres de habilidades mÃ¡s amigables
(...args: unknown[]) => unknown getSkillDisplayName(skill: TPAESHabilidad): string {
  const skillNames: Record<TPAESHabilidad, string> = {
    SOLVE_PROBLEMS: "ResoluciÃ³n de problemas",
    REPRESENT: "RepresentaciÃ³n",
    MODEL: "Modelamiento",
    INTERPRET_RELATE: "InterpretaciÃ³n y relaciÃ³n",
    EVALUATE_REFLECT: "EvaluaciÃ³n y reflexiÃ³n",
    TRACK_LOCATE: "UbicaciÃ³n y localizaciÃ³n",
    ARGUE_COMMUNICATE: "ArgumentaciÃ³n y comunicaciÃ³n",
    IDENTIFY_THEORIES: "IdentificaciÃ³n de teorÃ­as",
    PROCESS_ANALYZE: "Procesamiento y anÃ¡lisis",
    APPLY_PRINCIPLES: "AplicaciÃ³n de principios",
...
// FunciÃ³n para generar un mensaje basado en el rendimiento
(...args: unknown[]) => unknown getPerformanceMessage(score: number): string {
  if (score >= 90) {
    return "Â¡Excelente! Tienes un dominio sobresaliente de estas habilidades.";
  } else if (score >= 75) {
    return "Muy buen desempeÃ±o. Dominas bien la mayorÃ­a de los conceptos.";
  } else if (score >= 60) {
    return "Buen trabajo. Tienes un dominio adecuado pero hay espacio para mejorar.";
  } else if (score >= 40) {
    return "Hay varias Ã¡reas que requieren refuerzo. Trabaja en los conceptos bÃ¡sicos.";
  } else {
