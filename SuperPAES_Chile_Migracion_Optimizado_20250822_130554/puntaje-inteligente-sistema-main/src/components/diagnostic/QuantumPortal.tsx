      ...
      <div className="absolute inset-0">
        ...
        <div className="quantum-particles">
          {Array.from({ length: 50 }).map((_, i) => (
            <motion.div
              key={i}
              className="absolute w-1 h-1 bg-blue-400 rounded-full dynamic-particle-position"
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          {[1, 2, 3].map((ring) => (
            <motion.div
              key={ring}
              className="absolute border border-blue-400/30 rounded-full dynamic-ring-size"
              data-width={ring * 200}
              data-height={ring * 200}
              animate={{
                rotate: 360,
                scale: [1, 1.1, 1],
                opacity: [0.3, 0.6, 0.3]
            ...
            <CardContent className="p-8">
              ...
              >
                ...
                <h1 className="text-4xl font-bold text-white mb-4 tracking-wider">
                  PORTAL CUÃNTICO DE DIAGNÃ“STICO
                </h1>
                <p className="text-blue-300 text-lg">
                  Iniciando evaluaciÃ³n neuroadaptativa PAES Pro
                </p>
              </motion.div>
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <span className="text-blue-300">EnergÃ­a CuÃ¡ntica</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                >
                  ...
                  <div className="text-yellow-400 font-mono text-sm">DIAGNÃ“STICO</div>
                ...
                {quantumReady && (
                  ...
                  >
                    ...
                    >
                      ...
                      INICIAR DIAGNÃ“STICO CUÃNTICO
                      <ChevronRight className="w-6 h-6 ml-3" />
                    </Button>
                    
                    <p className="text-gray-400 text-sm mt-4">
                      Preparado para evaluaciÃ³n neuroadaptativa
                    </p>
                  </motion.div>
                )}
              </AnimatePresence>
