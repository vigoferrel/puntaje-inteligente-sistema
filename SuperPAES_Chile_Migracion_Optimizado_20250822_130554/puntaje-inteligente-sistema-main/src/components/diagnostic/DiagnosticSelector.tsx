...
// Agrupar diagnÃ³sticos por tipo de prueba
  ...
  if (tests.length === 0) {
    return (
      <Card className="text-center p-6">
        <CardTitle className="mb-4">No hay diagnÃ³sticos disponibles</CardTitle>
        <CardDescription>
          No se encontraron pruebas diagnÃ³sticas. IntÃ©ntalo nuevamente mÃ¡s tarde.
        </CardDescription>
      </Card>
    );
  }
              ...
              >
                ...
                >
                  ...
                  <CardFooter>
                    ...
                    >
                      {test.isCompleted ? 'Repetir diagnÃ³stico' : 'Comenzar diagnÃ³stico'}
                    </Button>
                  </CardFooter>
                </Card>
              </motion.div>
