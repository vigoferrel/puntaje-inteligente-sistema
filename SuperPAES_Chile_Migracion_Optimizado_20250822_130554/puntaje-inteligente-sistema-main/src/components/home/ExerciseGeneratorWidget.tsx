...
export const ExerciseGeneratorWidget: FC<ExerciseGeneratorWidgetProps> = ({ subjects }) => {
  ...
  return (
    <Card className="bg-gradient-to-br from-primary/10 to-purple-500/10 border-primary/20">
      ...
      <CardContent className="space-y-6">
        ...
        {highPrioritySubjects.length > 0 && (
          <div>
            <h3 className="font-semibold mb-3 flex items-center gap-2">
              ...
              Materias que Requieren AtenciÃ³n Inmediata
            </h3>
        ...
        {/* Acceso RÃ¡pido a Todas las Materias */}
        <div>
          <h3 className="font-semibold mb-3">Acceso RÃ¡pido por Materia</h3>
        ...
        <div className="bg-white/50 rounded-lg p-4 text-center">
          <h4 className="font-semibold mb-2">Â¿Necesitas prÃ¡ctica especÃ­fica?</h4>
