    ...
    >
      ...
      >
        <motion.div 
          ...
          className="dynamic-border" data-style="{"--dynamic-border": galaxy.color }"
        >
          <div className="text-lg font-bold mb-2" data-style="{"--dynamic-color": galaxy.color }">
            {galaxy.name}
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="w-full bg-gray-700 rounded-full h-2">
              <motion.div 
                ...
                className="dynamic-bg" data-style="{"--dynamic-bg": galaxy.color }"
                initial={{ width: 0 }}
