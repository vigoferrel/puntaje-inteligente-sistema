...
export const ChatSettingsPanel: FC = () => {
    ...
    <div className="p-4 space-y-6">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-medium">ConfiguraciÃ³n del Chat</h3>
        </div>
        <Button 
          variant="outline" 
          size="sm"
        ...
        <div className="space-y-2">
          ...
          >
            <div className="flex items-center space-x-1">
              ...
              <Label htmlFor="font-sm">PequeÃ±o</Label>
            </div>
            <div className="flex items-center space-x-1">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center space-x-2 py-2">
          ...
          />
          <Label htmlFor="enter-to-send">Usar Enter para enviar mensaje (Shift+Enter para nueva lÃ­nea)</Label>
        </div>
        ...
        <div className="flex items-center space-x-2 py-2">
          ...
          />
          <Label htmlFor="auto-expand-images">Expandir imÃ¡genes automÃ¡ticamente</Label>
        </div>
        ...
        <div className="flex items-center space-x-2 py-2">
          ...
          />
          <Label htmlFor="notification-sound">Sonido de notificaciÃ³n al recibir mensajes</Label>
        </div>
      </div>
    </div>
  );
