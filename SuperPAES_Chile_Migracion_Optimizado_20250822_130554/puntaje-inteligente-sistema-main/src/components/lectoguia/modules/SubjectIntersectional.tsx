...
const SUBJECTS = [
  {
    ...
    description: 'AnÃ¡lisis y comprensiÃ³n de textos',
    color: 'blue',
    icon: BookOpen
  },
  {
    id: 'MATEMATICA_1',
    name: 'MatemÃ¡tica M1',
    description: 'Ãlgebra y geometrÃ­a bÃ¡sica',
    color: 'green',
    icon: Target
  },
  {
    id: 'MATEMATICA_2',
    name: 'MatemÃ¡tica M2',
    description: 'CÃ¡lculo y estadÃ­stica',
    color: 'purple',
    icon: TrendingUp
  },
  {
...
export const SubjectIntersectional: React.FC<SubjectIntersectionalProps> = ({
  ...
  const getSubjectLevel = (progress: number) => {
    ...
    if (progress >= 50) return { level: 'BÃ¡sico', color: 'text-yellow-600' };
          ...
          {context.diagnosticResults && (
            <div className="bg-blue-50 p-3 rounded-lg border border-blue-200">
              <div className="flex items-center gap-2 text-blue-800 mb-2">
                ...
                <span className="font-medium">Basado en tu diagnÃ³stico</span>
              </div>
