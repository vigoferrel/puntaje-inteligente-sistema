...
export const ContextualActionButtons: FC<ContextualActionButtonsProps> = ({
  context,
  subject,
  skill,
  prueba,
  ...
  // FunciÃ³n para obtener el icono segÃºn la materia o prueba
  ...
  // Renderiza botones especÃ­ficos segÃºn el contexto
...
const getSubjectName = (subject: string): string => {
  const subjects: Record<string, string> = {
    ...
    'matematicas-basica': 'matemÃ¡ticas bÃ¡sica',
    'matematicas-avanzada': 'matemÃ¡ticas avanzada',
    'ciencias': 'ciencias',
    'historia': 'historia'
  };
...
const getSkillName = (skill: TPAESHabilidad): string => {
  const skills: Record<string, string> = {
    'TRACK_LOCATE': 'LocalizaciÃ³n textual',
    'INTERPRET_RELATE': 'InterpretaciÃ³n',
    'EVALUATE_REFLECT': 'EvaluaciÃ³n',
    'SOLVE_PROBLEMS': 'ResoluciÃ³n de problemas',
    'REPRESENT': 'RepresentaciÃ³n',
    'MODEL': 'Modelamiento',
    'ARGUE_COMMUNICATE': 'ArgumentaciÃ³n',
    'IDENTIFY_THEORIES': 'IdentificaciÃ³n cientÃ­fica',
    'PROCESS_ANALYZE': 'AnÃ¡lisis cientÃ­fico',
    'APPLY_PRINCIPLES': 'AplicaciÃ³n cientÃ­fica',
