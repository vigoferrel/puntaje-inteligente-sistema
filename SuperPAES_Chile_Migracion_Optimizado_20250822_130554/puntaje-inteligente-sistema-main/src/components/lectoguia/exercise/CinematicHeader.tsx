...
export const CinematicHeader: FC<CinematicHeaderProps> = ({
  exercise,
  exerciseSource,
  timeElapsed,
  progress
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="space-y-2">
              <h1 className="text-2xl font-bold text-foreground">
                {exercise.prueba ? getPruebaDisplayName(exercise.prueba as unknown) : 'Ejercicio Educativo'}
              </h1>
              
              <div className="flex items-center gap-3">
                <Badge variant="outline" className="text-xs font-medium">
                  {exercise.nodeId ? 'Nodo EspecÃ­fico' : 'Ejercicio General'}
                </Badge>
