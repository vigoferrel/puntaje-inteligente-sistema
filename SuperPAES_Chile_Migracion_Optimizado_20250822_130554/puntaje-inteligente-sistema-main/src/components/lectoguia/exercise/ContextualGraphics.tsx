...
export const ContextualGraphics: FC<ContextualGraphicsProps> = ({ exercise }) => {
  ...
  // Generar visualizaciÃ³n contextual basada en el tipo de ejercicio
      ...
      return (
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="font-medium">VisualizaciÃ³n MatemÃ¡tica</span>
          </div>
          ...
          <p className="text-xs text-muted-foreground">
            RepresentaciÃ³n visual de conceptos matemÃ¡ticos
          </p>
        </motion.div>
      );
    }
      ...
      return (
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="font-medium">Diagrama CientÃ­fico</span>
          </div>
          ...
          <p className="text-xs text-muted-foreground mt-4">
            RepresentaciÃ³n molecular interactiva
          </p>
        </motion.div>
      );
    }
      ...
      return (
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="font-medium">AnÃ¡lisis Textual</span>
          </div>
          
          <div className="space-y-3">
            {['ComprensiÃ³n', 'AnÃ¡lisis', 'SÃ­ntesis', 'EvaluaciÃ³n'].map((skill, i) => (
