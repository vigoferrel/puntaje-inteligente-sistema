...
export const BloomRecommendations: FC<BloomRecommendationsProps> = ({
  skillLevels,
  nodes,
  nodeProgress,
  className,
  ...
  // (...args: unknown[]) => unknown to get color class based on Bloom level
  ...
  return (
    <Card className={className}>
      <CardHeader>
        ...
        <CardDescription>
          Basadas en el anÃ¡lisis de tus niveles cognitivos (TaxonomÃ­a de Bloom)
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {recommendedNodes.length === 0 && (
          <div className="text-center py-4 text-muted-foreground">
            No hay nodos especÃ­ficos recomendados en este momento.
            ContinÃºa practicando con los nodos disponibles.
          </div>
        )}
      </CardContent>
    </Card>
