...
export const SkillNodeConnection: FC<SkillNodeConnectionProps> = ({
  skillLevels,
  nodes,
  nodeProgress,
  onNodeSelect,
  ...
  // Inicializar un objeto vacÃ­o para agrupar nodos por habilidad
  ...
  // Inicializar el objeto con arrays vacÃ­os para cada habilidad
          ...
          <div className="mb-3 flex justify-between items-center">
            ...
            <div className="w-24 h-2 bg-secondary rounded-full overflow-hidden">
              <div 
                ...
                className="dynamic-progress-fill" data-progress={(skillLevels[skill] || 0) * 100}
              />
            </div>
          </div>
                    ...
                    >
                      ...
                      {progress && (
                        <div className="mt-2 w-full h-1 bg-secondary rounded-full overflow-hidden">
                          <div 
                            className="h-full bg-primary" 
                            className="dynamic-progress-fill" data-progress={progress.progress * 100}
                          />
                        </div>
                      )}
                    </div>
