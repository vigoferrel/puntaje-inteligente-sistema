...
export const ActiveLearningNodes: FC<ActiveLearningNodesProps> = ({
  nodes,
  nodeProgress,
  className,
  limit = 5,
    ...
    return (
      <Card className={className}>
        <CardHeader>
          ...
          <CardDescription>
            Â¡Felicidades! Has completado todos los nodos disponibles.
          </CardDescription>
        </CardHeader>
      </Card>
    );
  ...
  return (
    <Card className={className}>
      <CardHeader>
        <CardTitle>Nodos de Aprendizaje Activos</CardTitle>
        <CardDescription>
          ContinÃºa tu aprendizaje con estos nodos
        </CardDescription>
      </CardHeader>
      <CardContent>
