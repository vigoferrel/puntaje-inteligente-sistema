...
export const SubjectSelector: FC<SubjectSelectorProps> = ({ 
  ...
  const subjectOptions = [
    { value: 'lectura', label: 'ComprensiÃ³n Lectora', prueba: 'COMPETENCIA_LECTORA' },
    { value: 'matematicas-basica', label: 'MatemÃ¡tica 1', prueba: 'MATEMATICA_1' },
    { value: 'matematicas-avanzada', label: 'MatemÃ¡tica 2', prueba: 'MATEMATICA_2' },
