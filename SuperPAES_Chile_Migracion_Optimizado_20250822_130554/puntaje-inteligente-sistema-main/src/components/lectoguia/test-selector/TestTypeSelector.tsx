...
const TEST_CONFIGS = {
  ...
  'MATEMATICA_1': {
    ...
    bgLight: 'bg-green-50',
    description: 'MatemÃ¡ticas 7Â° a 2Â° medio'
  },
  'MATEMATICA_2': {
    icon: BarChart3,
    ...
    description: 'MatemÃ¡ticas 3Â° y 4Â° medio'
  },
  'CIENCIAS': {
    icon: Atom,
  ...
  'HISTORIA': {
    ...
    bgLight: 'bg-red-50',
    description: 'Historia, geografÃ­a y cs. sociales'
  }
} as const;

export const TestTypeSelector: FC<TestTypeSelectorProps> = ({
  selectedTest,
  onTestSelect,
  className
}) => {
