...
export const ChatTab: React.FC<ChatTabProps> = ({ 
  ...
  // Obtener informaciÃ³n de la materia actual
          ...
          <div className="px-3 pt-2">
            <Alert variant="destructive">
              ...
              <AlertDescription>
                ...
                Algunos ejercicios podrÃ­an no corresponder exactamente a la materia seleccionada.
              </AlertDescription>
            </Alert>
          </div>
        )}
        
        {/* ConfirmaciÃ³n de materia activa */}
        <div className="px-3 py-2">
          <Alert>
            <CheckCircle className="h-4 w-4" />
            <AlertDescription>
              <strong>Materia activa:</strong> {subjectDisplayNames[activeSubject]}. 
              Todos los ejercicios y nodos se filtrarÃ¡n para esta materia especÃ­ficamente.
            </AlertDescription>
          </Alert>
        </div>
