    ...
    return (
      <Alert className="border-green-200 bg-green-50">
        ...
        <AlertTitle className="text-green-800">
          Sistema Completamente Coherente âœ¨
        </AlertTitle>
        <AlertDescription className="text-green-700">
          <div className="space-y-2">
            <p>Todos los nodos de {currentTest} son coherentes temÃ¡ticamente.</p>
            <div className="flex items-center gap-2 text-sm">
              <BarChart3 className="h-3 w-3" />
              <span>ValidaciÃ³n integral completada</span>
              {lastValidation && (
                <span className="text-xs opacity-75">
                  â€¢ {lastValidation.toLocaleTimeString()}
                </span>
              )}
            </div>
          </div>
        ...
        <AlertDescription className="text-orange-700">
          <div className="space-y-3">
            <p>
              ...
              El sistema aplicÃ³ correcciones automÃ¡ticas donde fue posible.
            </p>
            ...
            <div className="flex items-center gap-2 pt-2">
              ...
              {lastValidation && (
                <span className="text-xs text-orange-600">
                  Ãšltima verificaciÃ³n: {lastValidation.toLocaleTimeString()}
                </span>
              )}
            </div>
            
            <div className="text-xs text-orange-600 bg-orange-100 p-2 rounded">
              ðŸ’¡ Tip: Revisa la consola del navegador para ver detalles especÃ­ficos de cada problema.
            </div>
          </div>
        </AlertDescription>
      </Alert>
