...
export const SimulationResults: FC<SimulationResultsProps> = ({
  results,
  onReturnToSelector
}) => {
  if (!results) {
  ...
  const downloadResults = () => {
    // LÃ³gica para exportar resultados a PDF
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl font-semibold">Resultados de la simulaciÃ³n</h2>
          <p className="text-muted-foreground">
            {getPruebaDisplayName(results.prueba)} Â· {new Date(results.timestamp).toLocaleDateString()}
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardDescription>EstimaciÃ³n basada en tu desempeÃ±o</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Tabs defaultValue="general">
        ...
        <TabsContent value="general" className="mt-4">
          <Card>
            <CardHeader>
              <CardTitle>DistribuciÃ³n de respuestas</CardTitle>
              <CardDescription>
                AnÃ¡lisis de tu rendimiento en la simulaciÃ³n
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value="habilidades" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Desglose de tu desempeÃ±o en cada habilidad evaluada
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value="recomendaciones" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Basado en los resultados de tu simulaciÃ³n
              </CardDescription>
            </CardHeader>
                ...
                .map((skill, index) => (
                  <div key={index} className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Te recomendamos enfocarte en mejorar esta habilidad. Intenta practicar con ejercicios especÃ­ficos.
                    </p>
                    <Separator />
                  </div>
                ))
