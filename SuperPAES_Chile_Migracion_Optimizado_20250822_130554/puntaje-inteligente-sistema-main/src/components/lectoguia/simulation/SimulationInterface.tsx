...
export const SimulationInterface: React.FC<SimulationInterfaceProps> = ({
  ...
  // Verificar si el tiempo estÃ¡ por agotarse
  ...
  // Renderizar navegaciÃ³n de preguntas
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-xl font-semibold">SimulaciÃ³n PAES</h2>
      ...
      {/* NavegaciÃ³n rÃ¡pida de preguntas */}
      <Card>
        <CardContent className="p-4">
          <div className="flex items-center justify-between mb-2">
            <h3 className="font-medium">NavegaciÃ³n de preguntas</h3>
        ...
        <Card className="bg-warning/10 border-warning">
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm">Â¿EstÃ¡s seguro de que deseas finalizar la simulaciÃ³n?</p>
