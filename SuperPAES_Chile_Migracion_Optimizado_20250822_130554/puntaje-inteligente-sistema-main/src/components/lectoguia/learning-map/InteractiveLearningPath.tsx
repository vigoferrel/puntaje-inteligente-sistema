...
export const InteractiveLearningPath: React.FC<InteractiveLearningPathProps> = ({
  ...
  // Organizar nodos por posiciÃ³n dentro de la prueba seleccionada
  const sortedNodes = useMemo(() => {
    return [...filteredNodes].sort((a, b) => a.position - b.position);
  }, [filteredNodes]);

  // Obtener configuraciÃ³n de colores para la prueba actual
  ...
  // Calcular estadÃ­sticas de la prueba
  ...
  return (
    <div className="space-y-6">
      {/* Header especÃ­fico de la prueba */}
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className={`${testConfig.text} opacity-80`}>
                {sortedNodes.length} nodos â€¢ {Math.round(totalTime / 60)}h estimadas
              </p>
            </div>
          </div>
      ...
      <div className="relative">
        {/* LÃ­nea de conexiÃ³n con color de la prueba */}
          ...
          {sortedNodes.map((node, index) => {
            ...
            return (
              <motion.div
                ...
                className="relative"
              >
                {/* Punto de conexiÃ³n con color de la prueba */}
