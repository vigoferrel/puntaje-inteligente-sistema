        ...
        <CardContent className="space-y-4">
          <div className="text-center">
            <p className="text-white/70 mb-4">
              Cargando LectoGuÃ­a IA y componentes neurales...
            </p>
            
            <div className="w-full bg-white/20 rounded-full h-2 mb-4">
              <div 
                className="bg-gradient-to-r from-blue-400 to-cyan-400 h-2 rounded-full transition-all duration-300"
                className="dynamic-progress-fill" data-progress="Math.min(90, expression)"
              />
            </div>
            ...
            <div className="space-y-3">
              <Alert className="bg-yellow-500/20 border-yellow-500/30">
                ...
                <AlertDescription className="text-yellow-100">
                  La inicializaciÃ³n estÃ¡ tomando mÃ¡s tiempo del esperado.
                </AlertDescription>
              </Alert>
              ...
              <p className="text-xs text-white/50 text-center">
                El modo emergencia carga funcionalidades bÃ¡sicas
              </p>
            </div>
          )}
        </CardContent>
