    ...
    return (
      <Card className="bg-gray-800/50 border-gray-700">
        <CardContent className="p-6 text-center">
          ...
          <p className="text-white">Cargando mÃ©tricas de seguridad...</p>
        </CardContent>
      </Card>
    );
  }
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-400">MÃ©tricas Monitoreadas</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-400">
                {enableRealTime ? '5s' : 'Manual'}
              </div>
              <div className="text-sm text-gray-400">Frecuencia ActualizaciÃ³n</div>
            </div>
          </div>
        </CardContent>
      </Card>
