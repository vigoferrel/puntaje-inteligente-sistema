...
export const SystemHealthDashboard: React.FC = () => {
  ...
  const analyzeSystemHealth = async () => {
    try {
      ...
      // Issues crÃ­ticos que afectan funcionalidad
      ...
      // Configuraciones informativas (no crÃ­ticas)
      detectedIssues.push({
        id: 'auth-config-info',
        type: 'info',
        category: 'Configuration',
        title: 'ConfiguraciÃ³n Auth Optimizada',
        description: 'OTP expiry configurado a 30 minutos y protecciÃ³n contra passwords filtrados habilitada',
      ...
      detectedIssues.push({
        ...
        description: 'Servicios automÃ¡ticos de universidades y beneficios estudiantiles funcionando correctamente',
        status: 'informational',
        priority: 'low',
        actionable: false
      });

      // Calcular salud general basada solo en problemas crÃ­ticos
      ...
      setIssues([{
        ...
        description: 'No se pudo completar el anÃ¡lisis de salud del sistema',
        status: 'needs_attention',
        priority: 'medium',
        actionable: true
      }]);
        ...
        <CardContent>
          <div className="flex items-center justify-between mb-4">
            ...
            <Badge className={
              ...
              {systemHealth > 95 ? 'Excelente' : 
               systemHealth > 80 ? 'Bueno' : 'Requiere AtenciÃ³n'}
            </Badge>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 text-sm">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-400">Problemas CrÃ­ticos</div>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <Card className="bg-gray-800/50 border-gray-700">
          <CardContent className="p-6 text-center">
            ...
            <h3 className="text-white font-semibold mb-2">
              {filter === 'critical' ? 'No hay problemas crÃ­ticos' :
