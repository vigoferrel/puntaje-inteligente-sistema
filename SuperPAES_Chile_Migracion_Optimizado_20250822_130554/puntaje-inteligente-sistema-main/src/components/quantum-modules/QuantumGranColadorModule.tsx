/**
 * QUANTUM GRAN COLADOR MODULE - FILTRADO INTELIGENTE OPTIMIZADO
 * Context7 + Sequential Thinking - Modulo especializado del Gran Colador Cuantico
 * Filtra 200+ nodos PAES → 10-15 relevantes usando IA y Context7
 * SIN INLINE STYLES - Usando CSS Modules
 */
...
const QuantumGranColadorModule: React.FC<QuantumGranColadorModuleProps> = ({
  isActive = true,
  onNodeSelect,
  maxNodes = 15
}) => {
...
export default QuantumGranColadorModule;