...
export const QuantumInsights: FC<QuantumInsightsProps> = ({
  cinematicMetrics,
  predictions,
  onQuantumAction
}) => {
  return (
    <div className="h-full p-8 bg-gradient-to-br from-yellow-900 via-amber-900 to-black">
      ...
      >
        ...
        <p className="text-white/80 text-xl">Predicciones IA para tu futuro acadÃ©mico</p>
      </motion.div>
        ...
        <Card className="bg-black/40 border-yellow-500/30 backdrop-blur-xl">
          <CardContent className="p-6 text-center">
            ...
            <div className="text-sm text-white/70 mt-2">
              PrÃ³xima semana: {predictions.nextWeekScore}
            </div>
          </CardContent>
        </Card>
