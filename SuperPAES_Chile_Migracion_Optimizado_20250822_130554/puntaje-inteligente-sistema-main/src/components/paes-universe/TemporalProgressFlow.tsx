...
export const TemporalProgressFlow: FC<TemporalProgressFlowProps> = ({
  nodeProgress,
  nodes,
  onTimelineSelect
}) => {
  return (
    <div className="h-full p-8 bg-gradient-to-br from-green-900 via-teal-900 to-black">
      ...
      >
        ...
        <p className="text-white/80 text-xl">Tu lÃ­nea temporal de aprendizaje</p>
      </motion.div>
          ...
          <CardContent>
            <div className="text-white text-center">
              ...
              <div className="text-gray-400">
                VisualizaciÃ³n temporal de tu progreso acadÃ©mico
              </div>
            </div>
          </CardContent>
        </Card>
