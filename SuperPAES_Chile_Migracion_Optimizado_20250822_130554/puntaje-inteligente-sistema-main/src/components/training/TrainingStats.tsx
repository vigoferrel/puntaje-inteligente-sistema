...
export const TrainingStats: FC<TrainingStatsProps> = ({ stats }) => {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      <Card className="bg-gray-800 border-gray-700">
        ...
        <CardContent>
          ...
          <div className="text-xs text-gray-400 mt-1">
            {stats.averageAccuracy.toFixed(1)}% precisiÃ³n
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-gray-800 border-gray-700">
        ...
        <CardContent>
          ...
          <div className="text-xs text-gray-400">
            ~{Math.round(stats.timeSpent / stats.totalSessions)}m por sesiÃ³n
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-gray-800 border-gray-700">
        ...
        <CardContent>
          ...
          <div className="text-xs text-gray-400">
            Racha de {stats.streakDays} dÃ­as
          </div>
        </CardContent>
      </Card>
