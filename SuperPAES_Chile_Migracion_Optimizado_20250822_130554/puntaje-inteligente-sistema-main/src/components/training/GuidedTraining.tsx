...
export const GuidedTraining: FC = () => {
  const guidedPaths = [
    {
      id: 1,
      title: "Fundamentos de ComprensiÃ³n Lectora",
      description: "Domina las tÃ©cnicas bÃ¡sicas de anÃ¡lisis textual",
      progress: 75,
      lessons: 12,
      completed: 9,
      difficulty: "BÃ¡sico",
    ...
    {
      id: 2,
      title: "ResoluciÃ³n de Problemas MatemÃ¡ticos",
    ...
    {
      id: 3,
      title: "AnÃ¡lisis CientÃ­fico Avanzado",
      description: "InterpretaciÃ³n de datos y grÃ¡ficos cientÃ­ficos",
      progress: 0,
      lessons: 10,
      completed: 0,
      difficulty: "Avanzado",
  ...
  const getDifficultyColor = (difficulty: string) => {
    switch (difficulty) {
      case 'BÃ¡sico': return 'bg-green-600/20 text-green-300 border-green-500';
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-gray-800 border-gray-700">
        <CardHeader>
          <CardTitle className="text-white">Â¿CÃ³mo funcionan las Rutas Dirigidas?</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-medium text-white">ProgresiÃ³n Estructurada</div>
                  <div className="text-sm text-gray-400">
                    Cada lecciÃ³n se basa en la anterior, construyendo conocimiento sÃ³lido
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-400">
                    Completa rutas para desbloquear niveles mÃ¡s avanzados
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-medium text-white">EvaluaciÃ³n Continua</div>
                  <div className="text-sm text-gray-400">
                    Tu progreso se evalÃºa constantemente para adaptar el contenido
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-medium text-white">CertificaciÃ³n</div>
                  <div className="text-sm text-gray-400">
                    ObtÃ©n certificados al completar cada ruta de aprendizaje
                  </div>
                </div>
              </div>
            </div>
