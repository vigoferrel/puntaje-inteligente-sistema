...
export const VirtualAssistant: React.FC<VirtualAssistantProps> = ({
  ...
  const getContextualTips = (route: string): string[] => {
    switch (route) {
      case '/':
        return [
          'Comienza con LectoGuÃ­a para evaluar tu comprensiÃ³n lectora',
          'Realiza un diagnÃ³stico para conocer tu nivel actual',
          'Explora el planificador para crear tu estrategia de estudio'
        ];
      case '/lectoguia':
        return [
          'Sube una imagen o texto para anÃ¡lisis instantÃ¡neo',
          'Usa el chat para hacer preguntas especÃ­ficas',
          'Practica con ejercicios adaptativos'
        ];
      case '/diagnostico':
        return [
          'Selecciona las Ã¡reas PAES que quieres evaluar',
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-white/60 text-xs">AquÃ­ para ayudarte</p>
              </div>
            </div>
          ...
          {isFirstVisit && (
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-white font-medium text-sm">Â¡Bienvenido!</span>
              </div>
              <p className="text-white/80 text-xs mb-3">
                Te guiarÃ© por SuperPAES. Â¿Quieres hacer un tour completo?
              </p>
              <Button
