...
const navigationItems: QuickNavItem[] = [
  {
    id: 'diagnostic',
    title: 'DiagnÃ³stico PAES',
    description: 'EvaluaciÃ³n de nivel actual',
    icon: Target,
    route: '/diagnostic',
  ...
  },
  {
    id: 'lectoguia',
    title: 'LectoGuÃ­a IA',
    description: 'ComprensiÃ³n lectora con IA',
    icon: Award,
    route: '/lectoguia',
...
export const QuickNavigationWidget: FC = () => {
      ...
      <CardContent className="p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-white/70 text-sm">Accede a tus recursos de preparaciÃ³n</p>
          </div>
        </div>
        ...
        <div className="mt-6 pt-4 border-t border-white/10">
          <div className="grid grid-cols-3 gap-4 text-center">
            <div className="bg-white/5 rounded-lg p-2">
              ...
              <div className="text-white/60 text-xs">PreparaciÃ³n</div>
            </div>
            <div className="bg-white/5 rounded-lg p-2">
              <div className="text-green-400 font-bold text-lg">12</div>
              <div className="text-white/60 text-xs">DÃ­as activos</div>
            </div>
            <div className="bg-white/5 rounded-lg p-2">
