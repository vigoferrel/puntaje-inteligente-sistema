...
// Importar los mÃ³dulos de integraciÃ³n
    ...
    if (activeModule === 'overview') {
      return (
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <Card className="bg-white/5 border-white/10">
              <CardContent className="p-4 text-center">
                ...
                <div className="text-white/70 text-sm">Ãreas CrÃ­ticas</div>
              </CardContent>
            </Card>
            <Card className="bg-white/5 border-white/10">
              <CardContent className="p-4 text-center">
          ...
          {/* Grid de MÃ³dulos PAES Balanceado */}
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="grid grid-cols-3 gap-3 text-center">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-white/60">CrÃ­ticas</div>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
          ...
          {/* Widget de NavegaciÃ³n */}
          <QuickNavigationWidget />
        </div>
      );
    }

    // Renderizar contenido especÃ­fico del mÃ³dulo
    switch (activeModule) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-white/70 text-lg">
            PreparaciÃ³n integral para las 5 pruebas PAES
          </p>
        </motion.div>
