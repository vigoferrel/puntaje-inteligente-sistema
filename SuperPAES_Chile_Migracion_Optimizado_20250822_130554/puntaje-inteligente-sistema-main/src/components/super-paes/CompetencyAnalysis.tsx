...
export const CompetencyAnalysis: FC<CompetencyAnalysisProps> = ({
  competencias,
  analisis
}) => {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <h2 className="text-3xl font-bold text-white mb-2">AnÃ¡lisis de Competencias</h2>
        ...
        <Card className="bg-gradient-to-br from-green-600/20 to-emerald-600/20 backdrop-blur-xl border-green-300/30">
          ...
          <CardContent>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              {competenciasDestacadas.map((competencia: unknown, index: number) => (
                <CompetencyCard
      ...
      >
        <Card className="bg-gradient-to-br from-yellow-600/20 to-orange-600/20 backdrop-blur-xl border-yellow-300/30">
          ...
          <CardContent>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              {competenciasEnDesarrollo.map((competencia: unknown, index: number) => (
                <CompetencyCard
                  key={competencia.nombre}
                  competencia={competencia}
                  index={index}
...
const CompetencyProgressBar: FC<{
  competencia: unknown;
  index: number;
}> = ({ competencia, index }) => {
      ...
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-3">
          <div 
            ...
            className="dynamic-bg" data-style="{"--dynamic-bg": competencia.colorVisualizacion }"
          />
