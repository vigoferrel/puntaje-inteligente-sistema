...
interface NeuralNetworkVisualization3DProps {
  userType: UserType;
  [key: string]: unknown;
}

export const NeuralNetworkVisualization3D: React.FC<NeuralNetworkVisualization3DProps> = ({ userType, ...props }) => {
    ...
    >
      ...
      <div className="space-y-4">
        <div className="text-green-300">
          Componente de IA NeuralNetworkVisualization3D para usuario: {userType}
        </div>
...
export default NeuralNetworkVisualization3D;
