...
interface NeuralConnectionsAnimationProps {
  userType: UserType;
  [key: string]: unknown;
}

export const NeuralConnectionsAnimation: React.FC<NeuralConnectionsAnimationProps> = ({ userType, ...props }) => {
  ...
  return (
    ...
    >
      <h3 className="text-xl font-bold text-white mb-4">
        NeuralConnectionsAnimation
      </h3>
      
      <div className="space-y-4">
        <div className="text-green-300">
          Componente de IA NeuralConnectionsAnimation para usuario: {userType}
        </div>
...
export default NeuralConnectionsAnimation;
