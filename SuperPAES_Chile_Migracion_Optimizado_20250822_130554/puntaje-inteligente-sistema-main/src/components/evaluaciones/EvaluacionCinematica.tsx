...
interface EvaluacionCinematicaProps {
  ...
  onFinalizarEvaluacion: (resultados: unknown) => void;
}
...
export const EvaluacionCinematica: React.FC<EvaluacionCinematicaProps> = ({
  ...
  const [respuestas, setRespuestas] = useState<Record<number, { respuesta: string; analytics: unknown }>>({});
  ...
  const [progresoTiempoReal, setProgresoTiempoReal] = useState<unknown>(null);
  ...
  const cargarPreguntasEvaluacion = async () => {
    try {
      ...
      toast({
        title: "EvaluaciÃƒÂ³n Lista",
        description: `${resultado.preguntas.length} preguntas cargadas. Ã‚Â¡Comencemos!`
      });
    } catch (error) {
      console.error('Error cargando evaluaciÃƒÂ³n:', error);
      toast({
        title: "Error",
        description: "No se pudo cargar la evaluaciÃƒÂ³n. Intenta de nuevo.",
        variant: "destructive"
      });
    }
  };
  ...
  const manejarRespuesta = (respuesta: string, analytics: unknown) => {
    setRespuestas(prev => ({
      ...prev,
      [preguntaActual]: { respuesta, analytics }
    }));

    // Avanzar a la siguiente pregunta automÃƒÂ¡ticamente
    setTimeout(() => {
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 flex items-center justify-center">
        ...
        >
          ...
          <div className="text-white">
            <h2 className="text-2xl font-bold mb-2">Preparando EvaluaciÃƒÂ³n</h2>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-900 via-emerald-900 to-teal-900 flex items-center justify-center">
        ...
        >
          ...
          <h2 className="text-3xl font-bold">Ã‚Â¡EvaluaciÃƒÂ³n Completada!</h2>
  ...
  return (
    <div className="evaluacion-cinematica">
      {/* Header con informaciÃƒÂ³n de progreso */}
      <motion.div 
      ...
      >
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            {/* InformaciÃƒÂ³n de evaluaciÃƒÂ³n */}
            ...
            <div className="flex items-center gap-4">
              ...
              >
                {estadoEvaluacion === 'activa' ? <Pause className="w-4 h-4 w-4 h-4" />}
              </Button>
            </div>
          </div>
        </div>
          ...
          >
            <Card className="bg-black/50 border-white/20 text-white">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold mb-2">EvaluaciÃƒÂ³n Pausada</h3>
                <p className="text-white/80 mb-6">Presiona continuar cuando estÃƒÂ©s listo</p>
            ...
            {preguntaActualData.texto_base ? (
              <PreguntaComprensionLectora
                pregunta={{
                  ...
                  tipo_texto: preguntaActualData.tipo_texto as unknown,
                  ...
                  nivel_complejidad_lexica: preguntaActualData.nivel_complejidad_lexica as unknown,
              ...
              <PreguntaMatematica
                pregunta={{
                  ...
                  tipo_grafico: preguntaActualData.tipo_grafico as unknown,
      ...
      {/* NavegaciÃƒÂ³n de preguntas (para modo no automÃƒÂ¡tico) */}
      <motion.div
