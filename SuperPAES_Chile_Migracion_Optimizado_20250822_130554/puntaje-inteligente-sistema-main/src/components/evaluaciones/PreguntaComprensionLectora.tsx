...
export const PreguntaComprensionLectora: React.FC<PreguntaComprensionLectoraProps> = ({
  ...
  // Tracking de selecciÃƒÂ³n de texto
  ...
  // Manejo de selecciÃƒÂ³n de respuesta
  ...
  // EstimaciÃƒÂ³n de tiempo de lectura
      ...
      >
        <Card className="h-full m-4 shadow-xl">
          ...
          <CardContent className="flex-1 flex flex-col">
            ...
            {/* Panel de anÃƒÂ¡lisis expandible */}
            <motion.div className="mt-4">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  AnÃƒÂ¡lisis de lectura
                </div>
                {showAnalisisTexto ? <ChevronUp className="w-4 h-4 w-4 h-4" />}
              </Button>
        ...
        <Card className="h-full m-4 shadow-xl">
          <CardHeader>
            <div className="flex justify-between items-center">
              <CardTitle className="text-xl">Pregunta de ComprensiÃƒÂ³n</CardTitle>
              ...
              >
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-sm text-yellow-800">
                    <strong>Sugerencia:</strong> AsegÃƒÂºrate de leer todo el texto antes de responder. 
