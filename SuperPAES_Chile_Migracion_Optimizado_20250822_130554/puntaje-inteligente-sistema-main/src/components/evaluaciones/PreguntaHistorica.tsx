...
export const PreguntaHistorica: React.FC<PreguntaHistoricaProps> = ({
  ...
  const tabsDisponibles = [
    ...
    pregunta.cronologia && { id: 'cronologia', label: 'CronologÃƒÂ­a', icon: Calendar }
  ].filter(Boolean) as Array<{ id: 'documento' | 'mapa' | 'cronologia', label: string, icon: unknown }>;

  return (
    <div className="pregunta-historica h-screen flex">
      {/* Panel de recursos histÃƒÂ³ricos */}
      <motion.div 
      ...
      >
        <Card className="h-full m-4 shadow-xl">
          ...
          <CardContent className="flex-1 flex flex-col">
            {/* Tabs de navegaciÃƒÂ³n de recursos */}
              ...
              {pregunta.documento_fuente && (
                <TabsContent value="documento" className="flex-1 overflow-hidden">
                  <div className="h-full flex flex-col">
                    <div className="mb-3">
                      <h4 className="font-semibold">{pregunta.tipo_documento || 'Documento histÃƒÂ³rico'}</h4>
                      {pregunta.periodo_historico && (
                    ...
                    {/* InformaciÃƒÂ³n adicional del documento */}
            ...
            {/* Contexto histÃƒÂ³rico expandible */}
              ...
              <motion.div className="mt-4">
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    Contexto histÃƒÂ³rico
                  </div>
                  {showContexto ? <ChevronUp className="w-4 h-4 w-4 h-4" />}
                </Button>
        ...
        <Card className="h-full m-4 shadow-xl">
          <CardHeader>
            <div className="flex justify-between items-center">
              <CardTitle>Pregunta HistÃƒÂ³rica</CardTitle>
