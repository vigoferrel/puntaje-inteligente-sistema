...
export const LearningAnalytics: FC<LearningAnalyticsProps> = ({
  patterns,
  metrics,
  skillNodes
}) => {
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-400">PrecisiÃ³n IA</div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="p-3 bg-orange-600/20 rounded-lg border-l-4 border-orange-400">
              <div className="flex items-center gap-2">
                ...
                <span className="text-white text-sm">
                  Requiere refuerzo en {patterns.weakSubjects?.length || 0} Ã¡reas
                </span>
              </div>
            </div>
