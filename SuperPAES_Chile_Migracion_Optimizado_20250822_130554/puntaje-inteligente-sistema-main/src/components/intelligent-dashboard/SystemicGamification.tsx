...
export const SystemicGamification: React.FC<SystemicGamificationProps> = ({
  ...
  const achievements = React.useMemo(() => {
    const baseAchievements = [
      ...
      },
      {
        id: 'paes_warrior',
        title: 'Guerrero PAES',
        description: 'Alcanzar preparaciÃ³n Ã³ptima para PAES',
        icon: Shield,
  ...
  const challenges = [
    ...
    },
    {
      ...
      timeLeft: 'Sin lÃ­mite',
      reward: 'TÃ­tulo Especial + 350 XP',
      participants: 892,
    ...
    },
    {
      ...
      description: 'Mantener 95% de precisiÃ³n en 10 ejercicios consecutivos',
  ...
  const rewards = [
    ...
    },
    {
      ...
      description: '3 pistas gratuitas en ejercicios difÃ­ciles',
      cost: 150,
      icon: Target,
      available: true,
      color: 'from-blue-500 to-cyan-500'
    ...
    },
    {
      ...
      description: 'ExplicaciÃ³n detallada de cualquier concepto',
      cost: 300,
      icon: Gem,
      available: true,
      color: 'from-green-500 to-emerald-500'
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className="text-sm text-orange-200 mb-1">PrÃ³ximo Nivel</div>
              <div className="w-32">
        ...
        <Card className="bg-gradient-to-br from-black/40 to-slate-900/40 backdrop-blur-xl border-orange-500/30">
          <CardHeader>
            <CardTitle className="text-white flex items-center gap-2">
              ...
              ClasificaciÃ³n Semanal
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              {[
                { name: 'MarÃ­a GonzÃ¡lez', xp: 2450, level: 12, trend: 'up' },
                { name: 'Carlos Ruiz', xp: 2380, level: 11, trend: 'up' },
                { name: studentProfile.name, xp: totalXP, level: currentLevel, trend: 'stable' },
                { name: 'Ana LÃ³pez', xp: 2100, level: 10, trend: 'down' },
                { name: 'Diego PÃ©rez', xp: 1950, level: 9, trend: 'up' }
              ].map((player, index) => (
                <div
                  key={index}
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-xs text-gray-400">
                      {player.trend === 'up' ? 'â†—ï¸' : player.trend === 'down' ? 'â†˜ï¸' : 'âž¡ï¸'}
                    </div>
                  </div>
                </div>
              ))}
