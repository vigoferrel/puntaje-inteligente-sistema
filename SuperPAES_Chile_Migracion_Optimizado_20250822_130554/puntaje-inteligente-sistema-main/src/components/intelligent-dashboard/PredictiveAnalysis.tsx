...
export const PredictiveAnalysis: FC<PredictiveAnalysisProps> = ({
  skillNodes,
  patterns
}) => {
  ...
  const predictiveInsights = useMemo(() => {
    ...
    if (riskAreas.length > 0) {
      predictions.push({
        type: 'risk',
        title: 'Ãreas de Riesgo Detectadas',
        description: `${riskAreas.length} habilidades requieren atenciÃ³n inmediata`,
        confidence: 95,
        impact: 'alta',
    ...
    // Predecir oportunidades de aceleraciÃ³n
    ...
    if (accelerationOpportunities.length > 0) {
      predictions.push({
        type: 'opportunity',
        title: 'Oportunidades de AceleraciÃ³n',
    ...
    // Predecir tiempo de preparaciÃ³n
    ...
    predictions.push({
      type: 'timeline',
      title: 'ProyecciÃ³n de PreparaciÃ³n PAES',
      description: `Tiempo estimado para nivel Ã³ptimo: ${preparationTime} semanas`,
      confidence: 82,
      impact: 'alta',
      timeframe: `${preparationTime} semanas`,
      recommendations: ['Enfoque en habilidades crÃ­ticas', 'PrÃ¡ctica diaria constante', 'Evaluaciones semanales']
    });
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="text-center p-3 bg-blue-600/20 rounded-lg">
            ...
            <div className="text-xs text-gray-400">PreparaciÃ³n Global</div>
          </div>
                  ...
                  <div className="flex-1 space-y-3">
                    ...
                    <div className="space-y-1">
                      <div className="flex justify-between text-xs">
                        <span className="text-gray-400">PrecisiÃ³n del Modelo IA</span>
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <span className="text-purple-400 ml-2 font-medium">
                {patterns.learningTrends === 'improving' ? 'â¬†ï¸ Mejorando' : 
                 patterns.learningTrends === 'stable' ? 'âž¡ï¸ Estable' : 
                 'â¬‡ï¸ Necesita AtenciÃ³n'}
              </span>
            </div>
            <div>
              <span className="text-gray-400">PredicciÃ³n 30 dÃ­as:</span>
