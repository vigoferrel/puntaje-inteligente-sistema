...
export const ImmersiveVisualization3D: React.FC<ImmersiveVisualization3DProps> = ({
  ...
  useEffect(() => {
    ...
    // Datos de nodos para visualizaciÃƒÂ³n
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            >
              {isRotating ? <Pause className="w-4 h-4 w-4 h-4" />}
            </Button>
        ...
        <div className="relative">
          ...
          <div className="absolute top-4 left-4 space-y-2">
            ...
            <div className="flex items-center gap-2 text-xs text-red-300">
              ...
              <span>Requiere AtenciÃƒÂ³n (&lt;50%)</span>
            </div>
          </div>

          {/* Instrucciones de interacciÃƒÂ³n */}
          <div className="absolute bottom-4 right-4 text-xs text-green-300 text-right">
            <p>Click en nodos para detalles</p>
            <p>RotaciÃƒÂ³n automÃƒÂ¡tica: {isRotating ? 'ON' : 'OFF'}</p>
          </div>
        </div>

        {/* Panel de informaciÃƒÂ³n del nodo seleccionado */}
        {selectedNode && (
          <motion.div
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                <span className="text-gray-400">CÃƒÂ³digo:</span>
