...
interface PAESChallengeSystemProps {
  userType: UserType;
  [key: string]: unknown;
}

export const PAESChallengeSystem: React.FC<PAESChallengeSystemProps> = ({ userType, ...props }) => {
    ...
    >
      ...
      <div className="space-y-4">
        <div className="text-purple-300">
          Componente PAESChallengeSystem para usuario: {userType}
        </div>
...
export default PAESChallengeSystem;
