...
export const GamifiedAchievementSystem: React.FC<GamifiedAchievementSystemProps> = ({ userType, ...props }) => {
  ...
  return (
    ...
    >
      <h3 className="text-xl font-bold text-white mb-4">
        GamifiedAchievementSystem
      </h3>
      
      <div className="space-y-4">
        <div className="text-purple-300">
          Componente GamifiedAchievementSystem para usuario: {userType}
        </div>
