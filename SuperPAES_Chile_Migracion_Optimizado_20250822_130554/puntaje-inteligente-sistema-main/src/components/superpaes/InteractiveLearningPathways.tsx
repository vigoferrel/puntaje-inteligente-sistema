...
interface InteractiveLearningPathwaysProps {
  userType: UserType;
  [key: string]: unknown;
}

export const InteractiveLearningPathways: React.FC<InteractiveLearningPathwaysProps> = ({ userType, ...props }) => {
  ...
  return (
    ...
    >
      <h3 className="text-xl font-bold text-white mb-4">
        InteractiveLearningPathways
      </h3>
      
      <div className="space-y-4">
        <div className="text-purple-300">
          Componente InteractiveLearningPathways para usuario: {userType}
        </div>
...
export default InteractiveLearningPathways;
