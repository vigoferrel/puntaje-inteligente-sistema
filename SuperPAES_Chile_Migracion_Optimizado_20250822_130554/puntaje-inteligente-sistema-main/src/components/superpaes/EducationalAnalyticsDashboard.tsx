...
export const EducationalAnalyticsDashboard: React.FC<EducationalAnalyticsDashboardProps> = ({ userType, ...props }) => {
    ...
    >
      ...
      <div className="space-y-4">
        <div className="text-purple-300">
          Componente EducationalAnalyticsDashboard para usuario: {userType}
        </div>
...
export default EducationalAnalyticsDashboard;
