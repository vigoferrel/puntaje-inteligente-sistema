...
export const AdvancedSettings: React.FC = () => {
      ...
      <div>
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="practice">PrÃ¡ctica General</SelectItem>
          </SelectContent>
        </Select>
      </div>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-white/60 text-sm">IA ajusta automÃ¡ticamente la dificultad</p>
        </div>
        <Switch
      ...
      <div className="flex items-center justify-between">
        <div>
          <h4 className="text-white font-medium">AnÃ¡lisis Predictivo</h4>
  ...
  const renderAppearanceSettings = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h4 className="text-white font-medium">Modo CinematogrÃ¡fico</h4>
      ...
      <div className="flex items-center justify-between">
        <div>
          <h4 className="text-white font-medium">Efectos de PartÃ­culas</h4>
          <p className="text-white/60 text-sm">PartÃ­culas de fondo dinÃ¡micas</p>
        </div>
        <Switch
  ...
  const renderPrivacySettings = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h4 className="text-white font-medium">Compartir Datos AnÃ³nimos</h4>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-white/60 text-sm">MÃ©tricas de uso para optimizaciÃ³n</p>
        </div>
        <Switch
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <CardTitle className="text-white text-3xl">ConfiguraciÃ³n Avanzada</CardTitle>
