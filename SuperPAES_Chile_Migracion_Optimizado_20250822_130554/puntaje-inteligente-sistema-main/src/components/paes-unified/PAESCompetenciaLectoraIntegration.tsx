...
export const PAESCompetenciaLectoraIntegration: React.FC = () => {
  ...
  // Datos simulados - en implementaciÃ³n real vendrÃ­an del hook
  ...
  const textTypes = [
    ...
    { name: 'Textos PeriodÃ­sticos', progress: 75, questions: 10, color: 'text-yellow-400' }
  ];

  const readingSkills = [
    { skill: 'Localizar informaciÃ³n', level: 88, description: 'Encontrar datos especÃ­ficos en el texto' },
    ...
    { skill: 'Reflexionar y valorar', level: 62, description: 'Evaluar crÃ­ticamente el contenido' }
  ];
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-gray-800/50 rounded-lg p-4 text-center">
              ...
              <div className="text-sm text-gray-400">ComprensiÃ³n</div>
            </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <Card className="bg-gray-800 border-gray-700">
            <CardHeader>
              <CardTitle className="text-white">Habilidades de ComprensiÃ³n Lectora</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          {/* MÃ©tricas de velocidad y eficiencia */}
          <Card className="bg-gray-800 border-gray-700">
            <CardHeader>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-gray-700/50 rounded-lg p-4">
                  ...
                  <div className="text-xs text-blue-400">Variedad de gÃ©neros</div>
                </div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-blue-600/10 border border-blue-600/30 rounded-lg">
                  ...
                  <ul className="text-sm text-gray-300 space-y-1">
                    <li>â€¢ Practica lectura en bloques de palabras</li>
                    <li>â€¢ Evita la subvocalizaciÃ³n</li>
                    <li>â€¢ Usa tÃ©cnicas de skimming para textos largos</li>
                  </ul>
                </div>
                
                <div className="p-4 bg-green-600/10 border border-green-600/30 rounded-lg">
                  <h4 className="font-medium text-white mb-2">Para Mejorar ComprensiÃ³n</h4>
                  <ul className="text-sm text-gray-300 space-y-1">
                    <li>â€¢ Identifica la estructura del texto antes de leer</li>
                    <li>â€¢ Practica hacer resÃºmenes mentales por pÃ¡rrafo</li>
                    <li>â€¢ Conecta la informaciÃ³n nueva con conocimientos previos</li>
                  </ul>
                </div>
                
                <div className="p-4 bg-purple-600/10 border border-purple-600/30 rounded-lg">
                  <h4 className="font-medium text-white mb-2">Para AnÃ¡lisis CrÃ­tico</h4>
                  <ul className="text-sm text-gray-300 space-y-1">
                    <li>â€¢ Identifica el propÃ³sito del autor</li>
                    <li>â€¢ Busca evidencias que apoyen los argumentos</li>
                    <li>â€¢ Practica distinguir entre hechos y opiniones</li>
                  </ul>
                </div>
              </div>
            </CardContent>
