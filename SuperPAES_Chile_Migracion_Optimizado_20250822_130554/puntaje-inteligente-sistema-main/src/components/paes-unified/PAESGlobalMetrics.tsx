...
export const PAESGlobalMetrics: FC<PAESGlobalMetricsProps> = ({
  metrics,
  testPerformances,
  className
}) => {
          ...
          <Card className="bg-gray-800 border-gray-700">
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-400">Nivel de PreparaciÃ³n</p>
          ...
          <Card className="bg-gray-800 border-gray-700">
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-400">Probabilidad AdmisiÃ³n</p>
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-gray-300">AcciÃ³n Recomendada</span>
              ...
              {metrics.priorityTests.length > 0 && (
                <div>
                  <p className="text-gray-400 text-sm mb-2">Tests que requieren atenciÃ³n:</p>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 mt-1">
                      ...
                      <span className="text-sm text-blue-400">
                        {Math.round(performance.accuracy)}% precisiÃ³n
                      </span>
                    </div>
                  </div>
