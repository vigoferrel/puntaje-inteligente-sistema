...
export const PAESPlanMetrics: FC<PAESPlanMetricsProps> = ({
  metrics,
  loading = false
}) => {
  if (loading) {
        ...
        <Card className="border-green-200 bg-green-50">
          <CardContent className="p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-green-700">PrecisiÃ³n PAES</span>
            </div>
        ...
        <Card className="border-purple-200 bg-purple-50">
          <CardContent className="p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-purple-700">PreparaciÃ³n</span>
            </div>
