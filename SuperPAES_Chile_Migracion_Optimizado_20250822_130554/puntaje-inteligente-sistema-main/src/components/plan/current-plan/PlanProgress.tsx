...
export (...args: unknown[]) => unknown PlanProgress({ progress, plan }: PlanProgressProps) {
    ...
    <CardContent className="space-y-6">
            ...
            <PieChart>
              ...
              >
                ...
                <Label
                  ...
                  position="center"
                  fill="#374151"
                  className="dynamic-style" data-style="{fontSize: '20px', fontWeight: 'bold' }"
                />
              </Pie>
            </PieChart>
          </ResponsiveContainer>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 pt-2">
              ...
              <div className="flex items-center text-xs">
                ...
                <span className="text-muted-foreground">
                  {daysLeft !== null ? `${daysLeft} dÃ­as restantes` : "Sin fecha lÃ­mite"}
                </span>
              </div>
            </div>
          </div>
      ...
      {daysLeft !== null && daysLeft < 7 && daysLeft > 0 && (
        <Alert variant="destructive" className="mt-4">
          <AlertDescription>
            Â¡Quedan solo {daysLeft} dÃ­as para alcanzar tu meta! Incrementa tu ritmo de estudio.
          </AlertDescription>
        </Alert>
      )}
    </CardContent>
