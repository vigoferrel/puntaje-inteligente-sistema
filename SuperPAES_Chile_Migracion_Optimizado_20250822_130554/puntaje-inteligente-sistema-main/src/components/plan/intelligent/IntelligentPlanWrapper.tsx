...
export const IntelligentPlanWrapper: React.FC = () => {
  ...
  // Datos simulados basados en mÃ©tricas reales
  const userMetrics = {
  ...
  const weeklyProgress = [
    ...
    { day: 'MiÃ©rcoles', planned: 5, completed: 4, efficiency: 80 },
    { day: 'Jueves', planned: 3, completed: 3, efficiency: 100 },
    { day: 'Viernes', planned: 4, completed: 3, efficiency: 75 },
    { day: 'SÃ¡bado', planned: 2, completed: 2, efficiency: 100 },
  ...
  const handlePlanGenerated = (plan: unknown) => {
    setActivePlan(plan);
  ...
  const handleTaskComplete = (taskId: string) => {
    if (activePlan) {
      const updatedTasks = activePlan.tasks.map((task: unknown) =>
        task.id === taskId ? { ...task, completed: true, progress: 100 } : task
      );
      const completedCount = updatedTasks.filter((t: unknown) => t.completed).length;
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900 flex items-center justify-center">
        <Card className="bg-white/10 border-white/20 backdrop-blur-lg">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-white/70">Preparando sistema de planificaciÃ³n inteligente...</p>
          </CardContent>
        </Card>
      </div>
    );
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-purple-200 text-lg">
                    Sistema de planificaciÃ³n con IA basado en tus datos reales
                  </p>
                </div>
              </div>
        ...
        >
          ...
          <Card className="bg-black/20 backdrop-blur-lg border-white/10">
            <CardContent className="p-4 text-center">
              ...
              <div className="text-xs text-gray-400">Tasa FinalizaciÃ³n</div>
            </CardContent>
          </Card>
          <Card className="bg-black/20 backdrop-blur-lg border-white/10">
            <CardContent className="p-4 text-center">
              ...
              <div className="text-xs text-gray-400">Ãreas Fuertes</div>
            </CardContent>
          </Card>
          <Card className="bg-black/20 backdrop-blur-lg border-white/10">
            <CardContent className="p-4 text-center">
