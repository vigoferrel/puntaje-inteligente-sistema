...
export const PAESTestSelector: FC<PAESTestSelectorProps> = ({
  paesTests,
  selectedTests,
  onTestToggle,
  loading = false
  ...
  // Colores segÃºn el nivel de debilidad
  ...
  // Icono de estado segÃºn nivel de debilidad
  ...
  const getStatusLabel = (level: string, progress: number) => {
    if (level === 'high') return 'CrÃ­tico';
    if (level === 'medium') return 'Mejorar';
    if (progress > 80) return 'SÃ³lido';
    ...
    <div className="space-y-4">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-400 text-sm">
          Basado en tu diagnÃ³stico, te recomendamos enfocarte en las Ã¡reas marcadas como crÃ­ticas
        </p>
      </div>
      ...
      {selectedTests.length > 0 && (
        ...
        >
          ...
          <p className="text-sm text-gray-300">
            ...
            El sistema generarÃ¡ un plan integrado considerando las habilidades transversales.
          </p>
        </motion.div>
      )}
    </div>
