...
export const GoalSelector: FC<GoalSelectorProps> = ({
  ...
  const goals: Goal[] = [
    {
      id: 'comprehensive',
      title: 'PreparaciÃ³n Integral PAES',
      ...
      estimatedWeeks: 16,
      difficulty: 'Avanzado',
      focus: ['Todas las pruebas', 'IntegraciÃ³n', 'Simulacros'],
      recommended: weakestSkills.length >= 3
    },
    {
      id: 'reading_focus',
      title: 'Fortalecimiento Competencia Lectora',
      description: 'EspecializaciÃ³n en comprensiÃ³n lectora, anÃ¡lisis textual y evaluaciÃ³n crÃ­tica',
      icon: BookOpen,
      ...
      focus: ['Localizar informaciÃ³n', 'Interpretar', 'Evaluar'],
    ...
    {
      id: 'math_mastery',
      title: 'Dominio MatemÃ¡tico',
      description: 'Fortalecimiento en matemÃ¡ticas M1 y M2, resoluciÃ³n de problemas y modelamiento',
      icon: Brain,
      ...
      estimatedWeeks: 12,
      difficulty: 'Avanzado',
      focus: ['ResoluciÃ³n problemas', 'Modelamiento', 'RepresentaciÃ³n'],
      recommended: weakestSkills.some(skill => 
    ...
    },
    {
      ...
      description: 'Mejora en biologÃ­a, fÃ­sica y quÃ­mica con Ã©nfasis en argumentaciÃ³n cientÃ­fica',
      icon: Zap,
      ...
      estimatedWeeks: 10,
      difficulty: 'Intermedio',
      focus: ['TeorÃ­as cientÃ­ficas', 'AnÃ¡lisis', 'ArgumentaciÃ³n'],
      recommended: weakestSkills.some(skill => 
    ...
    },
    {
      ...
      description: 'Desarrollo en pensamiento temporal, anÃ¡lisis de fuentes y pensamiento crÃ­tico',
      icon: Target,
      ...
      estimatedWeeks: 8,
      difficulty: 'BÃ¡sico',
      focus: ['Pensamiento temporal', 'AnÃ¡lisis fuentes', 'CrÃ­tico'],
      recommended: weakestSkills.some(skill => 
    ...
    },
    {
      ...
      description: 'Enfoque especÃ­fico en las Ã¡reas mÃ¡s dÃ©biles segÃºn tu diagnÃ³stico',
      icon: TrendingUp,
      ...
      estimatedWeeks: 8,
      difficulty: 'Intermedio',
      focus: ['Ãreas crÃ­ticas', 'Reforzamiento', 'PrÃ¡ctica intensiva'],
  ...
  return (
    <div className="space-y-4">
      ...
      {/* InformaciÃ³n adicional para la meta seleccionada */}
      {selectedGoal && (
        <motion.div
          ...
          {(() => {
            ...
            return selected && (
              <p className="text-sm text-gray-300">
                {selected.title} - {selected.estimatedWeeks} semanas de duraciÃ³n. 
                Este plan se adaptarÃ¡ automÃ¡ticamente a tus fortalezas y debilidades identificadas.
              </p>
            );
          })()}
        </motion.div>
