...
export const PlanVisualizationDashboard: FC<PlanVisualizationDashboardProps> = ({
  metrics,
  weeklyProgress,
  subjectPerformance
}) => {
      ...
      <Card className="bg-gradient-to-r from-cyan-900/40 to-blue-900/40 backdrop-blur-xl border-cyan-500/30">
        <CardHeader>
          <CardTitle className="text-white flex items-center gap-3">
            ...
            Dashboard de PlanificaciÃ³n Inteligente
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-300">DÃ­as Consecutivos</div>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center space-y-2">
              ...
              <div className="text-sm text-gray-300">Tasa de FinalizaciÃ³n</div>
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="p-3 bg-white/5 rounded-lg border-l-4 border-green-500">
                <p className="text-green-400 font-medium">âœ¨ Fortaleza Detectada</p>
                <p className="text-sm text-gray-300">
                  Tu consistencia en matemÃ¡ticas es excelente. Considera aumentar la dificultad.
                </p>
              </div>
              <div className="p-3 bg-white/5 rounded-lg border-l-4 border-yellow-500">
                <p className="text-yellow-400 font-medium">âš¡ OptimizaciÃ³n Sugerida</p>
                <p className="text-sm text-gray-300">
              ...
              <div className="p-3 bg-white/5 rounded-lg border-l-4 border-blue-500">
                <p className="text-blue-400 font-medium">ðŸŽ¯ Meta Recomendada</p>
                <p className="text-sm text-gray-300">
                  EnfÃ³cate en ciencias esta semana para mantener el momentum.
                </p>
              </div>
            </div>
          </CardContent>
