...
export const IntelligentPlanGenerator: React.FC<IntelligentPlanGeneratorProps> = ({
  ...
  const generateIntelligentPlan = async (subject: string) => {
    ...
    // Simular IA generando plan basado en mÃ©tricas reales
    ...
    const tasks: StudyTask[] = [
      ...
      },
      {
        ...
        duration: 90,
        completed: false,
        resources: ['LectoGuÃ­a IA', 'Material complementario']
      },
      {
        id: `task_3_${subject}`,
        title: 'PrÃ¡ctica dirigida',
        type: 'ejercicios',
        duration: 60,
        completed: false,
      ...
      },
      {
        ...
        duration: 45,
        completed: false,
        resources: ['SuperPAES', 'AnÃ¡lisis de resultados']
      }
    ];
  ...
  const getSubjectRecommendation = (subject: string) => {
    if (userMetrics.weaknesses.includes(subject)) {
      return {
        type: 'Ãrea de mejora',
        color: 'text-red-400',
        icon: AlertTriangle,
        message: 'Requiere atenciÃ³n prioritaria'
      };
    }
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-xs text-gray-400">DuraciÃ³n Total</div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {plan.tasks.length > 3 && (
                      <p className="text-xs text-gray-500">
                        +{plan.tasks.length - 3} tareas mÃ¡s...
                      </p>
                    )}
                  </div>
