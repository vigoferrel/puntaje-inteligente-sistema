...
export const PlanProgressTracker: React.FC<PlanProgressTrackerProps> = ({
  ...
  const getTaskIcon = (type: string) => {
    switch (type) {
      ...
      case 'ejercicios': return 'âœï¸';
      case 'simulacro': return 'ðŸŽ¯';
      case 'repaso': return 'ðŸ”„';
      default: return 'ðŸ“';
    }
  };
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-300">DÃ­as Restantes</div>
            </div>
          </div>
          ...
          <Card className="bg-gradient-to-r from-green-900/40 to-emerald-900/40 backdrop-blur-xl border-green-500/30">
            <CardHeader>
              <CardTitle className="text-white flex items-center gap-3">
                ...
                SesiÃ³n Activa: {currentTask.title}
                {isStudying && (
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-300">DuraciÃ³n Estimada</div>
                </div>
                <div className="text-center">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-400">
                            {task.type} â€¢ {task.duration} minutos
                          </p>
                        </div>
                      </div>
