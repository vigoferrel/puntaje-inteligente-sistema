...
export const PlanNodeItem = ({
  ...
  return (
    <motion.div
      ...
      className="dynamic-style-prop" data-style-ref="recommendedStyles"
    ...
    >
      ...
      {isRecommended && (
        <div className="mt-3 bg-primary/5 rounded p-2 text-xs text-primary border border-primary/20">
          ...
          <p className="mt-1">
            Este mÃ³dulo es ideal para continuar tu progreso basado en tu rendimiento actual.
          </p>
        </div>
      )}
    </motion.div>
