...
export const PlanContent = ({
  ...
  const getCompletionStatus = () => {
    ...
    return {
      text: `${completedNodes}/${totalNodes} mÃƒÂ³dulos`,
      percentage
    };
  };
  ...
  const getRecommendationText = () => {
    ...
    if (streak >= 3) {
      return "Sigue con tu buena racha. Ã‚Â¡Ya llevas 3 dÃƒÂ­as o mÃƒÂ¡s!";
    } else if (streak > 0) {
      return "Ã‚Â¡Buen comienzo! ContinÃƒÂºa estudiando para mejorar tu racha.";
                  ...
                  <CardContent className="p-4">
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="text-sm font-medium">
                              {continueNode.nodeName || `MÃƒÂ³dulo ${continueNode.position}`}
                            </p>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="p-2 rounded-lg border border-green-100 bg-zinc-950">
                        ...
                        <Progress value={completionStatus.percentage} className="h-1.5 mt-1 bg-green-200 bg-green-600" />
                      </div>
