...
const DAYS_OF_WEEK = [
  ...
  { id: 3, name: 'MiÃ©rcoles', short: 'X' },
  { id: 4, name: 'Jueves', short: 'J' },
  { id: 5, name: 'Viernes', short: 'V' },
  { id: 6, name: 'SÃ¡bado', short: 'S' },
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto bg-gray-800 border-gray-700">
        <DialogHeader>
          ...
          <DialogDescription className="text-gray-400">
            Establece tu rutina semanal de estudio para optimizar tu preparaciÃ³n PAES
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4">
                    ...
                    <CardContent className="p-4">
                      ...
                      {session.isActive && (
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                          ...
                          <div>
                            <Label className="text-gray-300 text-sm">DuraciÃ³n</Label>
            ...
            <Card className="bg-yellow-600/10 border-yellow-600/30">
              ...
              <CardContent className="text-sm text-gray-300 space-y-1">
                <p>â€¢ MantÃ©n sesiones de 60-120 minutos para mÃ¡xima concentraciÃ³n</p>
                <p>â€¢ Estudia a la misma hora cada dÃ­a para crear hÃ¡bito</p>
                <p>â€¢ Programa al menos 10-15 horas semanales para resultados Ã³ptimos</p>
              </CardContent>
            </Card>
          </div>
        )}
