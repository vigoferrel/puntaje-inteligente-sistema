  ...
  const planTypes = [
    {
      ...
      timeCommitment: '3-4 horas/dÃ­a'
    },
    {
      id: 'weakness_focused' as const,
      title: 'Enfoque en Debilidades',
      description: 'Concentrado en Ã¡reas de menor rendimiento',
      icon: TrendingUp,
      estimatedImprovement: 35,
      timeCommitment: '2-3 horas/dÃ­a'
    },
    {
      id: 'skill_specific' as const,
      title: 'Habilidades EspecÃ­ficas',
      description: 'Desarrollo de competencias particulares',
      icon: Zap,
      estimatedImprovement: 20,
      timeCommitment: '1-2 horas/dÃ­a'
    }
  ];

  const availableTests = [
    { id: 'COMPETENCIA_LECTORA', name: 'ComprensiÃ³n Lectora', required: true },
    { id: 'MATEMATICA_1', name: 'MatemÃ¡tica M1', required: true },
    { id: 'MATEMATICA_2', name: 'MatemÃ¡tica M2', required: false },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            <CardTitle>DuraciÃ³n del Plan</CardTitle>
            <CardDescription>Semanas de estudio planificadas</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span>DuraciÃ³n: {config.duration} semanas</span>
                <Badge variant="outline">{config.duration * 7} dÃ­as</Badge>
              </div>
              <input
                type="range"
                min="4"
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-muted-foreground">
                      {intensity === 'light' && '1-2h/dÃ­a'}
                      {intensity === 'moderate' && '2-3h/dÃ­a'}
                      {intensity === 'intensive' && '3-4h/dÃ­a'}
                    </span>
                  </div>
                </div>
              ))}
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Basado en tu diagnÃ³stico y objetivos de aprendizaje
              </p>
            </div>
            <Button 
