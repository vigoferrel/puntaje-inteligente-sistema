# ============================================================================
# SUPERPAES CHILE - SISTEMA OFICIAL FINAL
# ============================================================================
# Para los alumnos de Chile - Alcanzando metas de puntaje PAES
# Contenidos 100% oficiales del MINEDUC
# ============================================================================

Write-Host "SUPERPAES CHILE - SISTEMA OFICIAL FINAL" -ForegroundColor Cyan
...
foreach ($meta in $diagnosticos.Keys) {
    Write-Host "  $meta:" -ForegroundColor Yellow
    foreach ($aspecto in $diagnosticos[$meta].Keys) {
        $valor = $diagnosticos[$meta][$aspecto]
