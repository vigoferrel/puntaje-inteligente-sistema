...
export const SimulacionesPAESTab: React.FC<SimulacionesPAESTabProps> = ({ onStartSimulation }) => {
  ...
  const materiasDisponibles = [
    { codigo: 'COMPETENCIA_LECTORA', nombre: 'Comprensión Lectora', icono: BookOpen, color: 'blue' },
    { codigo: 'MATEMATICA_1', nombre: 'Matemática M1', icono: Target, color: 'green' },
    { codigo: 'MATEMATICA_2', nombre: 'Matemática M2', icono: TrendingUp, color: 'purple' },
    { codigo: 'CIENCIAS', nombre: 'Ciencias', icono: Award, color: 'orange' },
    { codigo: 'HISTORIA', nombre: 'Historia y Geografía', icono: Trophy, color: 'red' }
  ];
                        ...
                        <CardContent className="p-4">
                          <div className="flex items-center gap-3 mb-3">
                            ...
                            <div>
                              ...
                              <p className="text-slate-400 text-sm">Simulación oficial PAES</p>
                            </div>
                          </div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <h3 className="text-white font-medium">
                        Simulación {resultado.simulationId.split('-')[1]?.toUpperCase()}
                      </h3>
                      <p className="text-slate-400 text-sm">
