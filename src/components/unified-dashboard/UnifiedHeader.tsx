...
export const UnifiedHeader: React.FC<UnifiedHeaderProps> = ({
  ...
  const tools = [
    ...
    { id: 'lectoguia', name: 'LectoGuía IA', icon: Brain, color: 'from-purple-500 to-pink-500' },
    { id: 'diagnostic', name: 'Diagnóstico', icon: Stethoscope, color: 'from-green-500 to-emerald-500' },
  ...
  const subjects = [
    { code: 'COMPETENCIA_LECTORA', name: 'Comprensión Lectora', short: 'CL', color: 'from-blue-400 to-cyan-400' },
    { code: 'MATEMATICA_1', name: 'Matemática M1', short: 'M1', color: 'from-green-400 to-emerald-400' },
    { code: 'MATEMATICA_2', name: 'Matemática M2', short: 'M2', color: 'from-purple-400 to-violet-400' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-8">
            ...
            {/* Botón de regreso cinematográfico */}
            ...
            {/* Navegación de herramientas cinematográfica */}
          ...
          <div className="flex items-center space-x-6">
            {/* Selector de Materia Cinematográfico */}
            <motion.div 
            ...
            {/* Herramientas Externas Cinematográficas */}
        ...
        {/* Barra de contexto cinematográfica */}
        {currentTool !== 'dashboard' && (
          ...
          >
            <div className="flex items-center justify-between text-sm">
              ...
              {/* Rutas de navegación cinematográficas */}
