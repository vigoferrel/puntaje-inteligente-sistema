          ...
          <CardHeader className="text-center">
            <div className="flex items-center justify-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-green-300 text-lg">Garantía de Excelencia Educativa</p>
              </div>
            </div>
          ...
          >
            <Card className="bg-black/40 backdrop-blur-xl border-white/20">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-sm text-gray-300">Precisión de Contenido</div>
              </CardContent>
            </Card>
          </motion.div>
          ...
          >
            <Card className="bg-black/40 backdrop-blur-xl border-white/20">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-sm text-gray-300">Satisfacción Usuario</div>
              </CardContent>
            </Card>
          </motion.div>
