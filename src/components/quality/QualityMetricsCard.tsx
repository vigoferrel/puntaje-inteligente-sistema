          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-green-300 text-sm">
                {overallScore >= 90 
                  ? 'Sistema funcionando con excelencia. Todos los estándares superados.'
                  : overallScore >= 80
                  ? 'Sistema en buen estado. Algunas métricas pueden mejorarse.'
                  : overallScore >= 70
                  ? 'Sistema funcional con advertencias. Revisar métricas críticas.'
                  : 'Sistema requiere atención inmediata. Múltiples métricas por debajo del umbral.'
                }
              </p>
            </div>
          </div>
