...
export const QualityValidationPanel: React.FC<QualityValidationPanelProps> = ({
  ...
  const [validationResults] = useState<ValidationResult[]>([
    ...
    },
    {
      ...
      status: 'warning',
      score: 78,
      issues: ['Algunos planes requieren más datos de entrada'],
      recommendations: ['Mejorar algoritmo de adaptación', 'Aumentar datos de usuario'],
      lastValidated: new Date()
    },
    {
      id: 'ai-content',
      ...
      score: 92,
      issues: [],
      recommendations: ['Implementar validación semántica avanzada'],
      lastValidated: new Date()
    },
    {
      id: 'user-interface',
      ...
      score: 88,
      issues: [],
      recommendations: ['Mejorar accesibilidad en dispositivos móviles'],
      lastValidated: new Date()
    }
  ]);
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">
                          Última validación: {result.lastValidated.toLocaleTimeString()}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
          ...
          <TabsContent value="reports" className="space-y-4">
            <div className="space-y-4">
              <div className="p-4 bg-gradient-to-r from-green-900/20 to-blue-900/20 rounded-lg border border-green-500/30">
                <h4 className="text-green-400 font-medium mb-2">✅ Sistema Validado</h4>
                <p className="text-gray-300 text-sm">
                  Todas las validaciones principales han pasado. El sistema está funcionando dentro de los parámetros esperados.
                </p>
              </div>
              
              <div className="p-4 bg-gradient-to-r from-blue-900/20 to-purple-900/20 rounded-lg border border-blue-500/30">
                <h4 className="text-blue-400 font-medium mb-2">📊 Reporte de Calidad</h4>
                <p className="text-gray-300 text-sm">
                  Score general: {overallScore}%. El sistema mantiene estándares altos de calidad con oportunidades de mejora identificadas.
                </p>
              </div>
              
              <div className="p-4 bg-gradient-to-r from-purple-900/20 to-pink-900/20 rounded-lg border border-purple-500/30">
                <h4 className="text-purple-400 font-medium mb-2">🔮 Predicciones</h4>
                <p className="text-gray-300 text-sm">
                  Con las mejoras propuestas, se proyecta un incremento del 8% en el score general durante los próximos 30 días.
                </p>
              </div>
            </div>
          </TabsContent>
