...
export const NeuralEcosystemHub: React.FC = () => {
  ...
  const viewConfigs = {
    enhanced3d: {
      ...
      description: 'Visualización avanzada de nodos con métricas neurales',
      icon: Brain,
    ...
    educational: {
      ...
      description: 'Exploración por materias y dominios PAES',
      icon: Globe,
          ...
          >
            ...
            <Card className="bg-black/30 backdrop-blur-sm border-yellow-500/30">
              <CardContent className="p-4 text-center">
                ...
                <div className="text-white font-medium">Partículas</div>
