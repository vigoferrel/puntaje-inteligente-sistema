...
export const LectoGuiaEmergencyMode: React.FC<LectoGuiaEmergencyModeProps> = ({
          ...
          <CardContent className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-sm text-white/60">
                LectoGuía está funcionando en modo simplificado. Algunas funciones pueden estar limitadas.
              </p>
            </div>
