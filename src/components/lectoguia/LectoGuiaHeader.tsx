...
export const LectoGuiaHeader: React.FC = () => {
  ...
  const testSkills = Object.entries(skillLevels).filter(([skill, level]) => {
    // Filtrar habilidades relevantes según el tipo de prueba
    const skillsByTest = {
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <Badge variant="secondary" className="bg-primary/10 text-primary">
              {selectedPrueba ? getPruebaDisplayName(selectedPrueba) : 'Comprensión Lectora'}
            </Badge>
          </div>
          ...
          >
            <div className="flex justify-between items-center mb-1">
              <span className="text-xs font-medium text-muted-foreground">
                Progreso en {selectedPrueba ? getPruebaDisplayName(selectedPrueba) : 'Comprensión Lectora'}
              </span>
