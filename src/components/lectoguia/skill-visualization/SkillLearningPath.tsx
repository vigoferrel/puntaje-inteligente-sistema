...
export const SkillLearningPath: React.FC<SkillLearningPathProps> = ({
  skillLevels,
  selectedTestId,
  className
}) => {
  ...
  return (
    <Card className={className}>
      <CardHeader>
        <CardTitle>Ruta de Aprendizaje</CardTitle>
        <CardDescription>
          Tu progresión de habilidades recomendada
        </CardDescription>
      </CardHeader>
      <CardContent>
        ...
        {recommendedSkills.length > 0 && (
          <div className="mb-6 p-4 bg-blue-50 border border-blue-100 rounded-lg">
            <h4 className="font-medium text-blue-700">Recomendación</h4>
            <p className="text-sm text-blue-600">
              Enfócate en mejorar {recommendedSkills.map(skill => getHabilidadDisplayName(skill)).join(', ')} 
