      ...
      <Tabs value={activeView} onValueChange={setActiveView}>
        <TabsList className="grid w-full grid-cols-4">
          ...
          <TabsTrigger value="skills" className="flex items-center gap-2">
            ...
            <span className="hidden md:inline">Árbol de Habilidades</span>
            <span className="md:hidden">Habilidades</span>
          </TabsTrigger>
          <TabsTrigger value="bloom" className="flex items-center gap-2">
            <TreePine className="h-4 w-4" />
            <span className="hidden md:inline">Taxonomía de Bloom</span>
            <span className="md:hidden">Bloom</span>
          </TabsTrigger>
          <TabsTrigger value="metrics" className="flex items-center gap-2">
            <Map className="h-4 w-4" />
            <span className="hidden md:inline">Métricas Detalladas</span>
