...
// Mapeo de habilidades por prueba con jerarquía
...
export const SkillTreeVisualization: React.FC<SkillTreeVisualizationProps> = ({
  ...
  // Función para obtener el color de la habilidad basado en el nivel
  ...
  const getSkillStatus = (level: number) => {
    ...
    if (level >= 0.2) return { status: 'Básico', icon: <BookOpen className="h-4 w-4" /> };
                  ...
                  <CardContent className="p-0">
                    ...
                    <div className="p-4 space-y-3">
                      ...
                      {selectedSkill === skill && relatedNodes.length > 0 && (
                        ...
                        >
                          <h5 className="font-medium text-sm">Nodos de práctica:</h5>
                                ...
                                >
                                  <div className="flex-1">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                      {node.difficulty} • {node.estimatedTimeMinutes || 30} min
                                    </p>
                                  </div>
                                  <Button
                                    size="sm"
                          ...
                          <div className="flex items-start gap-2">
                            ...
                            <div className="text-sm">
                              ...
                              <p className="text-blue-600">
                                {level < 0.3 
                                  ? "Practica los conceptos básicos" 
                                  : level < 0.6 
