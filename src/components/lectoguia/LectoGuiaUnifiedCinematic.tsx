                        ...
                        <div className="mt-2 flex items-center gap-2">
                          ...
                          >
                            ...
                            {message.source === 'oficial' ? 'Oficial PAES' : 
                             ...
                             message.source === 'hibrido' ? 'Híbrido' : 'Cache'}
                          </Badge>
              ...
              {currentExercise ? (
                <div className="space-y-4">
                  <div className="bg-slate-700/50 p-4 rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      >
                        {currentExercise.source === 'oficial' ? '🏛️ Oficial PAES' : '🧠 IA Optimizada'}
                      </Badge>
                      {currentExercise.metadata.costSaving && (
                        <Badge variant="outline" className="bg-green-500/20 text-green-300 border-green-500/30">
                          💰 ${currentExercise.metadata.costSaving.toFixed(3)} ahorrado
                        </Badge>
                      )}
                    </div>
                ...
                <div className="text-center py-8">
                  <p className="text-slate-400 mb-4">
                    ¿Listo para un ejercicio optimizado?
                  </p>
                  <Button
              ...
              <div className="space-y-4">
                ...
                {stats.optimizationStats && (
                  <div className="bg-slate-700/50 p-3 rounded-lg">
                    <div className="text-sm text-slate-300 mb-2">Optimización de Recursos</div>
