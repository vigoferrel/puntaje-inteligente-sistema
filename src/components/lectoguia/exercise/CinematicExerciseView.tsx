    ...
    return (
      <div className="min-h-[600px] flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground">Preparando experiencia cinematográfica...</p>
        </div>
      </div>
    );
  }
                ...
                {showFeedback && (
                  ...
                  >
                    ...
                    <p className="text-foreground/80 mb-6">
                      {isCorrect 
                        ? exercise.explanation || "¡Perfecto! Has demostrado un excelente dominio del tema."
            ...
            <div className="col-span-12 lg:col-span-4 space-y-6">
              ...
              >
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h4 className="font-semibold">Información del Ejercicio</h4>
                </div>
