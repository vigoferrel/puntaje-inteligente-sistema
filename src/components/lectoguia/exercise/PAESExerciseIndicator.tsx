...
export const PAESExerciseIndicator: React.FC<PAESExerciseIndicatorProps> = ({
  source,
  questionNumber,
  skill,
  difficulty,
          ...
          {isPAES && (
            <div className="mt-3 p-2 bg-green-100 rounded-md">
              <p className="text-xs text-green-700 flex items-center gap-1">
                ...
                Esta pregunta forma parte del examen oficial PAES y contribuye al análisis predictivo de tu puntaje.
              </p>
            </div>
          )}
        </CardContent>
