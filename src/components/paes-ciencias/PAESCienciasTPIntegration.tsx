    ...
    return (
      <Card className="bg-gray-800 border-gray-700">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-gray-300">Cargando integración PAES Ciencias TP...</p>
        </CardContent>
      </Card>
    );
  }
    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <Card className="bg-gradient-to-r from-purple-900/50 to-green-900/50 border-purple-700/50">
        <CardHeader>
          <CardTitle className="text-white flex items-center gap-2">
            ...
            PAES Ciencias Técnico Profesional 2024 - Forma 183
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-gray-800/50 rounded-lg p-4 text-center">
              ...
              <div className="text-sm text-gray-400">Preguntas Válidas</div>
            </div>
            
            <div className="bg-gray-800/50 rounded-lg p-4 text-center">
              <TrendingUp className="h-8 w-8 text-blue-400 mx-auto mb-2" />
              <div className="text-2xl font-bold text-white">3</div>
              <div className="text-sm text-gray-400">Áreas Científicas</div>
            </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <Card className="bg-gray-800 border-gray-700">
            <CardHeader>
              <CardTitle className="text-white">Distribución por Áreas Científicas</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  { area: 'BIOLOGIA', name: 'Biología', count: biologiaCount, range: '1-28' },
                  { area: 'FISICA', name: 'Física', count: fisicaCount, range: '29-54' },
                  { area: 'QUIMICA', name: 'Química', count: quimicaCount, range: '55-80' }
                ].map((item, index) => {
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <h4 className="text-lg font-semibold text-white">Módulo Común (54 preguntas)</h4>
                  <div className="space-y-2">
                    <div className="flex justify-between items-center p-3 bg-green-600/10 rounded-lg">
                      <span className="text-green-400">Biología</span>
                    ...
                    <div className="flex justify-between items-center p-3 bg-blue-600/10 rounded-lg">
                      <span className="text-blue-400">Física</span>
                ...
                <div className="space-y-4">
                  <h4 className="text-lg font-semibold text-white">Módulo Técnico Profesional (26 preguntas)</h4>
                  <div className="space-y-2">
                    <div className="flex justify-between items-center p-3 bg-purple-600/10 rounded-lg">
                      <span className="text-purple-400">Química</span>
                      <span className="text-white font-bold">26 preguntas</span>
                    </div>
                    <div className="text-sm text-gray-400 mt-2">
                      Específico para estudiantes de colegios Técnico Profesionales
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 p-4 bg-yellow-600/10 border border-yellow-600/30 rounded-lg">
                ...
                <p className="text-gray-300 text-sm">
                  {pilotQuestions} preguntas piloto están excluidas del puntaje (preguntas 11, 16, 35, 52, 80)
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="areas" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {['BIOLOGIA', 'FISICA', 'QUIMICA'].map((area) => {
              ...
              const areaName = area === 'BIOLOGIA' ? 'Biología' : 
                             area === 'FISICA' ? 'Física' : 'Química';
                ...
                <Card key={area} className="bg-gray-800 border-gray-700">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <Button 
                        onClick={() => generateAreaSimulation(area as any, 10)}
                        disabled={isLoading}
                        className="w-full"
                        variant="outline"
                      >
        ...
        <TabsContent value="modules" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="bg-gray-800 border-gray-700">
              <CardHeader>
                <CardTitle className="text-white">Módulo Común</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="text-center">
                  ...
                  <div className="space-y-2">
                    <div className="text-sm text-gray-300">Áreas incluidas:</div>
                    <Badge variant="outline" className="mr-2">Biología (28)</Badge>
                    <Badge variant="outline">Física (26)</Badge>
                  </div>
            ...
            <Card className="bg-gray-800 border-gray-700">
              <CardHeader>
                <CardTitle className="text-white">Módulo Técnico Profesional</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="text-center">
                  ...
                  <div className="space-y-2">
                    <div className="text-sm text-gray-300">Área incluida:</div>
                    <Badge variant="outline">Química (26)</Badge>
                  </div>
                  
                  <div className="text-xs text-gray-500">
                    Solo para estudiantes de colegios Técnico Profesionales
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Button 
                  ...
                  className="bg-purple-600 hover:bg-purple-700"
                >
                  Simulación Completa (40 preguntas)
                </Button>
              ...
              <div className="mt-6 p-4 bg-blue-600/10 border border-blue-600/30 rounded-lg">
                <div className="text-sm text-gray-300">
                  ...
                  excluyendo las preguntas piloto para una experiencia más realista.
                </div>
              </div>
            </CardContent>
          </Card>
