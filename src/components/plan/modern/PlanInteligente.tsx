    ...
    >
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="overview" className="space-y-6">
                    ...
                    >
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <Badge variant="outline" className="text-xs">
                          {test.weaknessLevel === 'critical' ? 'Crítico' :
          ...
          {/* Top Skills que necesitan atención */}
          <Card className="bg-gray-800 border-gray-700">
            <CardHeader>
              <CardTitle className="text-white">Habilidades que Requieren Atención</CardTitle>
            </CardHeader>
            <CardContent>
            ...
            <CardContent className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-gray-400 mb-6">
                  Basado en tu análisis personalizado, generaremos un plan óptimo que se enfoca en tus áreas de mayor impacto.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  <div className="bg-purple-600/10 border border-purple-600/30 rounded-lg p-4">
                    ...
                    <div className="text-xs text-gray-400">Prioriza áreas críticas</div>
                  </div>
                  
                  <div className="bg-blue-600/10 border border-blue-600/30 rounded-lg p-4">
                    <Clock className="h-8 w-8 text-blue-400 mx-auto mb-2" />
                    <div className="text-sm font-medium text-white">Cronograma Optimizado</div>
                    <div className="text-xs text-gray-400">Distribución eficiente</div>
                  </div>
