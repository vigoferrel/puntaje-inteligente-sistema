...
interface GoalScores {
  ...
  m1: number; // Matemática 1
  m2: number; // Matemática 2
...
const PAES_TESTS = [
  ...
  { key: 'm1', name: 'Matemática M1', icon: Calculator, color: 'text-green-400', required: true },
  { key: 'm2', name: 'Matemática M2', icon: Calculator, color: 'text-emerald-400', required: false },
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-gray-800 border-gray-700">
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            {/* Áreas prioritarias */}
            <div>
              <Label className="text-white text-base mb-3 block">Áreas Prioritarias (opcional)</Label>
              <div className="flex flex-wrap gap-2">
                {['Velocidad lectora', 'Comprensión', 'Resolución de problemas', 'Análisis', 'Memorización'].map((area) => (
                  <Badge
                    key={area}
