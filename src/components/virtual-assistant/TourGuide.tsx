...
const tourSteps = {
  complete: [
    {
      id: 'welcome',
      title: '¡Bienvenido a SuperPAES!',
      description: 'Tu plataforma integral de preparación para PAES con IA avanzada.',
      target: 'body',
    ...
    },
    {
      ...
      description: 'Aquí puedes ver tu progreso, métricas y acceder a todas las funcionalidades.',
    ...
    },
    {
      id: 'lectoguia',
      title: 'LectoGuía IA',
      description: 'Asistente inteligente para comprensión lectora y análisis de textos.',
    ...
    },
    {
      ...
      description: 'Evaluación inteligente que se adapta a tu nivel de conocimiento.',
  ...
  lectoguia: [
    {
      id: 'lectoguia-intro',
      title: 'LectoGuía IA',
      description: 'Tu asistente personal de comprensión lectora.',
    ...
    },
    {
      ...
      description: 'Puedes subir textos o imágenes para análisis instantáneo.',
  ...
  diagnostic: [
    {
      id: 'diagnostic-intro',
      title: 'Sistema de Diagnóstico',
      description: 'Evaluación adaptativa que se ajusta a tu rendimiento.',
    ...
    },
    {
      ...
      description: 'Elige qué áreas PAES quieres evaluar.',
    ...
    },
    {
      ...
      description: 'Obtén insights detallados sobre tu rendimiento.',
