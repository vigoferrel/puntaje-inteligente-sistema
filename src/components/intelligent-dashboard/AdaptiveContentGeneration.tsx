...
export const AdaptiveContentGeneration: React.FC<AdaptiveContentGenerationProps> = ({
  ...
  const handleGenerateContent = async (type: string) => {
    ...
    console.log(`🚀 Generando contenido adaptativo: ${type}`);
    
    // Simular generación de contenido
    setTimeout(() => {
      setGeneratingContent(false);
      console.log(`✅ Contenido ${type} generado exitosamente`);
    }, 2000);
  };
  ...
  const contentTypes = [
    {
      ...
      icon: Target,
      description: 'Ejercicios personalizados según tu nivel',
    ...
    },
    {
      ...
      icon: BookOpen,
      description: 'Contenido teórico personalizado',
        ...
        <CardContent className="space-y-6">
          ...
          <div className="p-4 bg-white/5 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <span className="text-gray-400">Gamificación:</span>
