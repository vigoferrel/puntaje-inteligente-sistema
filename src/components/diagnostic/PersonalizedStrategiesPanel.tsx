...
export const PersonalizedStrategiesPanel: React.FC<PersonalizedStrategiesPanelProps> = ({
  strategies,
  weakestArea,
  skillAnalysis,
  onGenerateExercises
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-orange-700">
                  Puntaje actual: {weakestArea.score} - Requiere atención inmediata
                </p>
              </div>
              <Button 
        ...
        <CardContent className="space-y-4">
          {strategies.length === 0 ? (
            <div className="text-center py-8 text-gray-500">
              ...
              <p>No hay estrategias disponibles. Completa una evaluación inicial.</p>
            </div>
          ) : (
                      ...
                      <div className="flex items-center space-x-2">
                        <Badge variant="outline" className="text-xs">
                          {exercise.type === 'official_paes' ? 'PAES Oficial' :
                           exercise.type === 'ai_generated' ? 'IA Generado' : 'LectoGuía'}
                        </Badge>
