...
export const IntelligentDiagnosticSystem: React.FC = () => {
  ...
  const generateRecommendations = () => {
    ...
    setRecommendations(recs.slice(0, 6)); // Máximo 6 recomendaciones
  };
    ...
    return (
      <div className="p-6 space-y-6">
        <div className="text-center">
          ...
          <p className="text-slate-400">Analizando sistema diagnóstico...</p>
        </div>
      </div>
    );
  }
        ...
        <Card className="bg-red-900/20 border-red-500/30">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-red-300">
              {error || 'El sistema diagnóstico no está listo. Verifica la configuración.'}
            </p>
          </CardContent>
        </Card>
      </div>
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Sistema Diagnóstico Inteligente</h1>
