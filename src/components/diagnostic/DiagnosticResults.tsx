    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-lg text-gray-600">
          Análisis completo de tu nivel actual en competencias PAES
        </p>
      </motion.div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600">Áreas Fuertes</div>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center space-x-2">
              ...
              <span>Análisis por Habilidades</span>
            </CardTitle>
          </CardHeader>
          <CardContent>
          ...
          <CardContent>
            {strongAreas.length > 0 ? (
              ...
              <p className="text-gray-500 text-center py-4">
                Continúa practicando para desarrollar tus fortalezas
              </p>
            )}
          </CardContent>
        </Card>
      ...
      >
        <p>
          Diagnóstico completado el {new Date(results.completedAt).toLocaleDateString('es-CL')}
        </p>
        <p className="mt-1">
