...
export interface DiagnosticControllerState {
  tests: ReturnType<typeof useDiagnostic>["tests"];
  loading: boolean;
  currentTest: ReturnType<typeof useDiagnostic>["currentTest"];
...
export const DiagnosticController: React.FC<DiagnosticControllerProps> = ({ children }) => {
  ...
  const controllerState: DiagnosticControllerState = {
    tests,
    loading,
    currentTest,
    selectedTestId,
