  ...
  return (
    <div className="space-y-6 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Nodos Críticos</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Cobertura Crítica</CardTitle>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Distribución por Prueba PAES</CardTitle>
          <CardDescription>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Organización jerárquica según el sistema PAES Pro
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                <Badge variant="destructive">Tier 1 - Crítico</Badge>
      ...
      {recommendedPath.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Nodos priorizados según el algoritmo adaptativo
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              ...
              {recommendedPath.length > 5 && (
                <div className="text-center text-sm text-muted-foreground pt-2">
                  +{recommendedPath.length - 5} nodos más en tu ruta personalizada
                </div>
              )}
            </div>
          </CardContent>
