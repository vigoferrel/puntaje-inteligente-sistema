...
export const ScholarshipCalculator: React.FC<ScholarshipCalculatorProps> = ({
  ...
  const calculateScholarships = async () => {
    ...
    // Simular cálculo con delay para efecto cinematográfico
    await new Promise(resolve => setTimeout(resolve, 1000));

    const scholarships = [
      {
        nombre: "Gratuidad",
        monto: "100% Matrícula + Arancel",
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-blue-200">
          Sistema de evaluación inteligente para maximizar tus oportunidades
        </p>
      </motion.div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                >
                  <option value="" className="text-black">Seleccionar</option>
                  <option value="pedagogia" className="text-black">Pedagogía</option>
                  <option value="universitaria" className="text-black">Universitaria</option>
                  <option value="tecnica" className="text-black">Técnica</option>
                </select>
              </div>
            </div>
          ...
          <CardContent>
            {calculating ? (
              ...
              <div className="space-y-4 max-h-96 overflow-y-auto">
                {results.map((scholarship: any, index) => (
                  <motion.div
                    key={index}
