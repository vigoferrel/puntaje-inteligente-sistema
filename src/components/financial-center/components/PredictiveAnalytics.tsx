...
export const PredictiveAnalytics: React.FC<PredictiveAnalyticsProps> = ({
  ...
  const scholarshipDistribution = [
    ...
    { name: 'Mérito', value: 20, color: '#F59E0B' }
  ];
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-violet-200">
          Inteligencia artificial proyectando tu éxito financiero
        </p>
      </motion.div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        {/* Distribución de probabilidades de becas */}
        <Card className="bg-black/60 backdrop-blur-lg border-violet-500/30">
          <CardHeader>
            <CardTitle className="text-white flex items-center">
          ...
          <div className="grid lg:grid-cols-3 gap-4">
            ...
            >
              <div className="flex items-center space-x-2 mb-3">
                ...
                <h4 className="text-green-400 font-bold">Optimización Alta</h4>
              </div>
              <p className="text-green-200 text-sm">
                Aumenta 2h/día de estudio en Matemática M1 para mejorar 85 puntos y asegurar Beca Vocación Profesor.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-yellow-200 text-sm">
                Completar FUAS antes del 13 marzo. Tiempo crítico para maximizar beneficios disponibles.
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center space-x-2 mb-3">
                ...
                <h4 className="text-blue-400 font-bold">Estrategia Óptima</h4>
              </div>
              <p className="text-blue-200 text-sm">
                Priorizar Competencia Lectora. 50 puntos adicionales garantizan Gratuidad + Excelencia Académica.
              </p>
            </motion.div>
          </div>
        </CardContent>
