...
export const FinancialHologram: React.FC<FinancialHologramProps> = ({
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // Círculos concéntricos holográficos
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="text-cyan-200 text-xs">Optimización</div>
      </motion.div>
      ...
      >
        <div className="text-cyan-400 text-sm font-bold">{metrics.daysToDeadline} días</div>
