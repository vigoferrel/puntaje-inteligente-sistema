...
export const PersonalizedFeedback: React.FC<PersonalizedFeedbackProps> = ({
  ...
  const [learningPatterns] = useState<LearningPattern[]>([
    {
      pattern: 'Máximo rendimiento matutino',
    ...
    {
      pattern: 'Mejora progresiva en matemáticas',
      description: 'Aumento constante del 15% semanal en habilidades matemáticas',
      frequency: 0.92,
      impact: 'positive',
      suggestion: 'Mantén la estrategia actual, considera aumentar dificultad'
    },
    {
      pattern: 'Fatiga después de 45 minutos',
      description: 'Disminución de concentración después de sesiones largas',
      frequency: 0.73,
      impact: 'negative',
      suggestion: 'Implementa descansos cada 45 minutos con técnica Pomodoro'
    },
    {
      pattern: 'Alta retención en comprensión lectora',
      ...
      const newFeedbacks: FeedbackMessage[] = [
        {
          ...
          message: 'Has mantenido una racha de estudio de 12 días consecutivos. Tu constancia está dando frutos con una mejora del 23% en tu rendimiento general.',
          priority: 'high',
          timestamp: new Date(),
          actionable: true,
          actions: ['Compartir logro', 'Ver análisis detallado'],
          context: 'Patrón de constancia',
          emotion: 'positive'
        },
        {
          id: '2',
          ...
          message: 'La IA ha identificado que tu rendimiento en matemáticas mejora 34% cuando practicas después de ejercicios de comprensión lectora. Te sugerimos esta secuencia.',
          priority: 'medium',
          timestamp: new Date(Date.now() - 1000 * 60 * 30),
          actionable: true,
          actions: ['Aplicar sugerencia', 'Ver detalles del patrón'],
          context: 'Análisis de secuencias de estudio',
          emotion: 'motivational'
        },
        {
          id: '3',
          type: 'insight',
          title: 'Patrón emocional identificado 💡',
          message: 'Hemos notado que tu motivación aumenta significativamente cuando completas nodos de dificultad creciente. Tu cerebro responde mejor a desafíos progresivos.',
          priority: 'medium',
          timestamp: new Date(Date.now() - 1000 * 60 * 60),
          actionable: true,
          actions: ['Ajustar plan de estudio', 'Ver investigación'],
          context: 'Análisis psicológico',
          emotion: 'neutral'
        },
        {
          id: '4',
          type: 'warning',
          title: 'Atención: Sobrecarga detectada ⚠️',
          message: 'Tus últimas 3 sesiones han mostrado signos de fatiga mental. Considera tomar un descanso de 15 minutos o cambiar a actividades más ligeras.',
          priority: 'high',
        ...
        },
        {
          ...
          message: 'Tu mejora en ciencias durante la última semana (18% de aumento) te coloca en el top 5% de estudiantes con tu perfil. ¡Sigue así!',
          priority: 'medium',
          timestamp: new Date(Date.now() - 1000 * 60 * 60 * 2),
          actionable: false,
          context: 'Comparación con pares',
          emotion: 'positive'
        }
      ];
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-blue-200">
                {isGeneratingFeedback ? 'Analizando patrones de aprendizaje...' : 'Sistema activo • 5 insights nuevos generados'}
              </p>
            </div>
            <Button
          ...
          {isGeneratingFeedback && (
            <div className="mt-4">
              ...
              <div className="text-sm text-blue-200 mt-2">
                Procesando: Patrones de comportamiento, rendimiento académico, estado emocional...
              </div>
            </div>
          )}
        </CardContent>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="text-xs text-white/70">
                            {feedback.context} • {feedback.timestamp.toLocaleTimeString('es-CL', { 
                              hour: '2-digit', 
                              minute: '2-digit' 
                            })}
                          </div>
              ...
              <CardContent>
                ...
                <div className="mb-4">
                  <div className="flex justify-between text-sm mb-2">
                    <span className="text-white/70">Confianza del patrón</span>
        ...
        {activeTab === 'coaching' && (
          <Card className="bg-black/40 border-green-500/30 backdrop-blur-xl">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-white/70 mb-4">Próximamente: Sesiones de coaching personalizadas con IA</p>
