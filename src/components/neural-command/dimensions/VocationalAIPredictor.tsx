  ...
  const [careerPredictions] = useState<CareerPrediction[]>([
    {
      ...
      salary: '$1.2M - $2.5M',
      growthRate: '+15% anual',
      factors: ['Alto rendimiento en matemáticas', 'Excelente lógica computacional', 'Pensamiento sistemático']
    },
    {
      career: 'Medicina',
      ...
      salary: '$1.8M - $4.0M',
      growthRate: '+8% anual',
      factors: ['Excelente en ciencias', 'Alta dedicación al estudio', 'Pensamiento analítico']
    },
    {
      career: 'Psicología',
      university: 'Universidad de Chile',
      ...
      salary: '$800K - $1.8M',
      growthRate: '+12% anual',
      factors: ['Excelente comprensión lectora', 'Análisis de comportamiento', 'Empatía desarrollada']
    },
    {
      ...
      salary: '$1.0M - $3.5M',
      growthRate: '+10% anual',
      factors: ['Pensamiento estratégico', 'Análisis cuantitativo', 'Liderazgo natural']
    }
  ]);
  ...
  const [aptitudeAnalysis] = useState<AptitudeAnalysis[]>([
    {
      ...
      score: 92,
      description: 'Excelente capacidad para el razonamiento lógico y matemático',
      careers: ['Ingeniería', 'Matemáticas', 'Física', 'Economía'],
      icon: Brain,
      color: 'from-blue-500 to-blue-700'
    },
    {
      area: 'Verbal-Lingüística',
      score: 88,
      description: 'Alta competencia en comprensión y expresión verbal',
      careers: ['Derecho', 'Periodismo', 'Literatura', 'Psicología'],
      icon: BookOpen,
    ...
    },
    {
      area: 'Científica',
      score: 85,
      description: 'Fuerte inclinación hacia el método científico',
      careers: ['Medicina', 'Biología', 'Química', 'Investigación'],
      icon: Zap,
    ...
    },
    {
      ...
      score: 78,
      description: 'Buena capacidad de visualización y diseño',
      careers: ['Arquitectura', 'Diseño', 'Arte', 'Ingeniería Civil'],
      icon: Eye,
    ...
    },
    {
      ...
      careers: ['Psicología', 'Trabajo Social', 'Educación', 'RR.HH.'],
      icon: Users,
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-cyan-200">
                {isAnalyzing ? 'Analizando patrones de aprendizaje...' : 'Análisis completado con 94% de precisión'}
              </p>
            </div>
            <Button
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 rounded-lg p-4">
                    ...
                    <div className="flex justify-between items-center mb-3">
                      <span className="text-sm text-gray-300">Tu Predicción PAES</span>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 p-3 bg-green-500/20 rounded-lg">
                  ...
                  <span className="text-white">Pensamiento analítico excepcional</span>
                </div>
                <div className="flex items-center gap-3 p-3 bg-blue-500/20 rounded-lg">
                  <Brain className="w-5 h-5 text-blue-400" />
                  <span className="text-white">Alta capacidad de resolución de problemas</span>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 p-3 bg-orange-500/20 rounded-lg">
                  ...
                  <span className="text-white">Gestión del tiempo bajo presión</span>
                </div>
                <div className="flex items-center gap-3 p-3 bg-yellow-500/20 rounded-lg">
                  <Eye className="w-5 h-5 text-yellow-400" />
                  <span className="text-white">Visualización espacial</span>
                </div>
        ...
        {activeTab === 'simulator' && (
          <Card className="bg-black/40 border-green-500/30 backdrop-blur-xl">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-white/70 mb-4">Próximamente: Simulador interactivo de decisiones vocacionales</p>
