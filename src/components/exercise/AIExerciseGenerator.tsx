...
const subjects = [
  ...
  { id: 'matematica-m1', name: 'Matemática M1', icon: Calculator, color: 'from-green-600 to-emerald-600', nodes: 25 },
  { id: 'matematica-m2', name: 'Matemática M2', icon: Calculator, color: 'from-purple-600 to-pink-600', nodes: 22 },
...
export const AIExerciseGenerator: React.FC = () => {
  ...
  const generateExercise = async () => {
    ...
    const difficultyLevel = difficulty < 30 ? 'Básico' : difficulty < 70 ? 'Intermedio' : 'Avanzado';
    
    const mockExercise = {
      id: `ex_${Date.now()}`,
      subject: subject?.name,
      difficulty: difficultyLevel,
      question: `¿Cuál de las siguientes alternativas mejor representa el concepto evaluado en ${subject?.name} a nivel ${difficultyLevel}?`,
      options: [
        'Primera alternativa que presenta un enfoque conceptual sólido',
        'Segunda alternativa con perspectiva metodológica diferente',
        'Tercera alternativa que incluye elementos complementarios',
        'Cuarta alternativa como distractor bien construido'
      ],
      correctAnswer: 0,
      explanation: `La respuesta correcta es A porque evalúa directamente los objetivos de aprendizaje de ${subject?.name} en nivel ${difficultyLevel}. Esta opción demuestra comprensión profunda del concepto y aplicación práctica del conocimiento.`,
          ...
          <Card className="bg-black/40 backdrop-blur-xl border-white/20">
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                  <label className="text-white text-sm font-medium mb-2 block">
                    Dificultad: {difficulty < 30 ? 'Básico' : difficulty < 70 ? 'Intermedio' : 'Avanzado'}
                  </label>
                  <Slider
                    value={[difficulty]}
                      ...
                      <React.Fragment key={subject.id}>
                        ...
                        <div>
                          ...
                          <div className="text-2xl font-bold text-green-400">
                            {difficulty < 30 ? 'Básico' : difficulty < 70 ? 'Intermedio' : 'Avanzado'}
                          </div>
