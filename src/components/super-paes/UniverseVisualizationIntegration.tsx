...
export const UniverseVisualizationIntegration: React.FC = () => {
  return (
    <motion.div
      ...
      <Card className="bg-gradient-to-br from-indigo-600 to-purple-600 border-white/20 h-full cursor-pointer">
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/80 text-sm">Visualización inmersiva</p>
            </div>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center gap-2 text-white/90 text-sm">
            ...
            <span>Exploración multidimensional</span>
          </div>
          <div className="flex items-center gap-2 text-white/90 text-sm">
