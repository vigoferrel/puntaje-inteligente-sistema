...
export const FinancialCenter: React.FC = () => {
  ...
  const calculateEligibleScholarships = (studentProfile: any): ScholarshipData[] => {
    return scholarships.filter(scholarship => {
      ...
      // Verificar requisitos socioeconómicos
  ...
  const runFinancialSimulation = async () => {
    ...
    try {
      ...
      const lifetimeEarnings = averageIncome * 12 * 40; // 40 años de trabajo
      ...
      if (user?.user?.id) {
        await supabase
          ...
          .insert({
            ...
            simulation_name: 'Simulación PAES 2024',
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label htmlFor="math-score">Matemática</Label>
                    <Input
                      id="math-score"
                      type="number"
                      max="1000"
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      {scholarship.puntaje_minimo_nem && (
                        <div className="flex justify-between">
                          <span className="text-sm">NEM Mínimo</span>
                      ...
                      {scholarship.renta_maxima_familiar && (
                        <div className="flex justify-between">
                          <span className="text-sm">Renta Máx. Familiar</span>
                          <span className="font-medium">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold mb-2">Simulación Avanzada</h3>
                <p className="text-muted-foreground mb-6">
                  Próximamente: Simulaciones con múltiples escenarios e IA predictiva
                </p>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold mb-2">Planificación Personalizada</h3>
                <p className="text-muted-foreground mb-6">
                  Próximamente: Planes de ahorro y estrategias de financiamiento personalizadas
                </p>
                <Button disabled className="gap-2">
                  <Target className="w-4 h-4" />
                  Próximamente
