...
const StudentModernDashboard: React.FC = () => {
  const { user } = useAuth();
      ...
      <div className="p-6">
        <Card className="border-amber-200 bg-amber-50">
          <CardContent className="p-6 text-center">
            ...
            <h3 className="text-lg font-semibold text-amber-800 mb-1">Comienza tu Preparación</h3>
            <p className="text-amber-600 mb-4">
              No tienes datos de progreso aún. ¡Comienza estudiando para ver tu avance!
            </p>
            <Button>
  ...
  const getProgressMessage = () => {
    if (metrics.overallProgress < 20) {
      return "¡Estás comenzando tu preparación! Mantén la constancia.";
    } else if (metrics.overallProgress < 50) {
      return "Vas por buen camino. Sigue así para alcanzar tus metas.";
    } else if (metrics.overallProgress < 80) {
      return "¡Excelente progreso! Estás cerca de completar tu preparación.";
    } else {
      return "¡Increíble! Estás muy bien preparado para la PAES.";
    }
  };
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-green-500">días consecutivos</p>
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <Card className="hover:shadow-md transition-shadow cursor-pointer">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Evalúa tu nivel actual en cada materia
            </p>
        ...
        <Card className="hover:shadow-md transition-shadow cursor-pointer">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Organiza tu preparación de forma eficiente
            </p>
            <Button variant="outline" className="w-full">
              Ver Plan
            </Button>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-cyan-700">Retención</p>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-cyan-600 mb-1">
          ...
          <div className="mt-4 p-3 bg-white rounded-lg border border-cyan-200">
            <p className="text-sm text-cyan-800">
              ...
              {metrics.weeklyGrowth < 20 
                ? "Dedica 15 minutos más al día para acelerar tu progreso."
                : metrics.retentionRate < 60
                ? "Repasa los conceptos anteriores para mejorar tu retención."
                : "¡Excelente ritmo! Mantén la constancia para alcanzar tus metas."}
            </p>
          </div>
        </CardContent>
      </Card>
...
export default StudentModernDashboard;
