...
export const CompetenciaLectoraIntegration: React.FC = () => {
  const competenciaData = {
    progress: 75,
    projectedScore: 670,
    completedSessions: 24,
    totalSessions: 40,
    strengths: ['Comprensión literal', 'Vocabulario', 'Síntesis'],
    weaknesses: ['Inferencias complejas', 'Análisis crítico'],
    recentActivities: [
