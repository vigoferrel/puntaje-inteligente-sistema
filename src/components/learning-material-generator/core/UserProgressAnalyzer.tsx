...
export const UserProgressAnalyzer: React.FC<UserProgressAnalyzerProps> = ({
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            No hay datos de progreso disponibles. Comienza estudiando para ver tu análisis.
          </p>
        </CardContent>
      </Card>
    );
  ...
  // Identificar áreas débiles y fuertes basado en progreso por materia
      ...
      <CardContent className="space-y-4">
        ...
        <div className="p-3 rounded-lg bg-blue-50 border border-blue-200">
          <div className="flex items-center gap-2 text-blue-800 mb-1">
            ...
            <span className="font-medium">Recomendación Personalizada</span>
          </div>
          <p className="text-blue-700 text-sm">
            {metrics.learningVelocity < 50 
              ? "Enfócate en ejercicios de refuerzo para mejorar tu velocidad de aprendizaje"
              : metrics.overallProgress < 30
              ? "Mantén el ritmo actual, estás progresando bien"
              : "Considera agregar ejercicios de mayor dificultad para desafiarte más"}
          </p>
        </div>
      </CardContent>
    </Card>
