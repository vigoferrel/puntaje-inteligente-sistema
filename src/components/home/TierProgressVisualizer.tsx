...
export const TierProgressVisualizer: React.FC<TierProgressVisualizerProps> = ({ 
  tierData, 
  className 
}) => {
  ...
  const getTierPriority = (tier: string) => {
    switch (tier) {
      case 'tier1_critico': return 'Crítico';
  ...
  return (
    <div className={`space-y-6 ${className || ''}`}>
      <div className="flex items-center justify-between">
        ...
        <Badge variant="outline">Sistema de Priorización</Badge>
      </div>
