...
import { 
  ...
  Sparkles, GamepadIcon, Crown, Rocket, Star
} from 'lucide-react';
...
const PAESUniverseDashboard: React.FC = () => {
    ...
    >
      <div className="flex space-x-2">
        {[
          ...
          { mode: 'battle', icon: GamepadIcon, label: 'Battle', color: 'from-red-500 to-orange-600' },
...
export default PAESUniverseDashboard;
