...
export const BattleDashboard: React.FC<BattleDashboardProps> = ({
  ...
  const achievements = [
    { name: 'Streak Master', description: '10 días consecutivos', icon: Flame, earned: true },
    { name: 'Speed Demon', description: 'Completar 5 nodos en 1 día', icon: Zap, earned: true },
  ...
  return (
    <div className="h-full bg-gradient-to-br from-red-900 via-purple-900 to-black p-8 overflow-y-auto">
      ...
      >
        ...
        <p className="text-white/80 text-xl">Domina las materias PAES en combate épico</p>
      </motion.div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Panel de estadísticas de batalla */}
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <div className="flex items-center space-x-4 mt-1">
                            ...
                            <span className="text-white/80">⏱️ {zone.timeLeft}</span>
                          </div>
                        </div>
                      </div>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                {[
                  ...
                  { rank: gameStats.nationalRank, name: 'TÚ', points: gameStats.battlePoints, change: '+32', highlight: true }
                ].map((player, index) => (
                  <motion.div
                    key={player.rank}
      ...
      {/* Overlay de animación de batalla */}
      <AnimatePresence>
        {battleAnimation && (
          <motion.div
