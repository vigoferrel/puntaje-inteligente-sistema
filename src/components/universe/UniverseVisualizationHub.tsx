          ...
          <CardContent>
            <div className="h-48 bg-black/20 rounded-lg flex items-center justify-center">
              <div className="text-white/60 text-center">
                ...
                <div>Visualización Estática</div>
              </div>
            </div>
          </CardContent>
        </Card>
    ...
    <SafeThreeProvider>
      <div className="space-y-6">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-white mb-2">Universo de Visualización PAES</h2>
          <p className="text-white/70">Exploración inmersiva del conocimiento educativo</p>
        </div>
        ...
        <div className="h-96 bg-black/20 rounded-lg border border-white/10">
          <Suspense fallback={
            ...
            {/* Aquí iría el componente Three.js real */}
            <div className="flex items-center justify-center h-full">
              <div className="text-white/60 text-center">
