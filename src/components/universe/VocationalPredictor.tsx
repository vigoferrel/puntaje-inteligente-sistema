...
export const VocationalPredictor: React.FC<VocationalPredictorProps> = ({
  userProgress,
  galaxies,
  onClose
}) => {
  const predictions = [
    {
      ...
      probability: 92,
      reason: "Excelente en matemáticas y física",
    ...
    },
    {
      career: "Psicología",
      probability: 78,
      reason: "Fortaleza en comprensión lectora",
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-6">
              <div className="text-white">
                <h2 className="text-2xl font-bold flex items-center space-x-2">
                  ...
                  <span>Predicción Vocacional IA</span>
                </h2>
                <p className="text-cyan-300 mt-1">
                  Análisis basado en tu perfil neurológico de aprendizaje
                </p>
              </div>
              <Button
                onClick={onClose}
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              <div className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-lg p-3 text-center">
                ...
                <div className="text-white text-sm">Proyección PAES</div>
              </div>
