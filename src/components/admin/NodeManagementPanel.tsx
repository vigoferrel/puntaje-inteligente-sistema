...
export const NodeManagementPanel: React.FC = () => {
  ...
  const subjects = [
    ...
    { key: 'MATEMATICA_1', label: 'Matemática M1' },
    { key: 'MATEMATICA_2', label: 'Matemática M2' },
  ...
  const tiers = [
    ...
    { key: 'tier1_critico', label: 'Tier 1 - Críticos' },
    ...
    try {
      ...
      if (result.isValid) {
        ...
        toast({
          ...
          description: `${result.issues.length} problemas detectados en la validación`,
          variant: "destructive"
        });
      }
    } catch (error) {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Panel de Gestión de Nodos - Sistema PAES Pro
          </CardTitle>
          <CardDescription>
            Gestión y validación de los 277 nodos de aprendizaje estructurados
          </CardDescription>
        </CardHeader>
              ...
              <CardContent>
                <div className="space-y-2">
                  ...
                  <p className={`text-sm ${getCoherenceColor(validationResult.stats.coherenceScore)}`}>
                    ...
                    {validationResult.stats.coherenceScore < 70 && " - Necesita atención"}
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="issues" className="space-y-4">
            {validationResult.issues.length > 0 ? (
              ...
              <Alert>
                ...
                <AlertDescription>
                  Todos los nodos están correctamente configurados y validados.
                </AlertDescription>
              </Alert>
            )}
          </TabsContent>
