...
export const MinimizablePerformanceMonitor: React.FC = () => {
  ...
  useEffect(() => {
    // Auto-mostrar si hay problemas críticos de performance
  ...
  // Auto-minimizar después de 10 segundos de inactividad
  useEffect(() => {
        ...
        {isMinimized ? (
          ...
          >
            <div className="flex items-center gap-2">
              ...
              >
                {report.isHealthy ? <CheckCircle className="w-3 h-3" /> : <AlertTriangle className="w-3 h-3" />}
              </Badge>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    ...
                    {report.isHealthy ? 'Saludable' : 'Optimización Necesaria'}
                  </Badge>
              ...
              <div className="space-y-3">
                <div className="grid grid-cols-2 gap-2 text-xs">
                  ...
                  <div className="bg-gray-800/50 p-2 rounded">
                    <div className="text-gray-400">Navegación</div>
                    <div className="text-white font-mono">
