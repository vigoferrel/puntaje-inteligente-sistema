            ...
            <div className="navigation-nodes absolute inset-0">
              {navigationNodes.map((node, index) => {
                ...
                return (
                  <motion.button
                    key={node.id}
                    className="navigation-node absolute"
                    style={{
                      left: '50%',
                      top: '50%',
                  ...
                  >
                    <div 
                      className={`relative bg-black/80 backdrop-blur-md rounded-2xl border p-4 min-w-[140px] ${
                        isActive(node.path) 
                      ...
                      style={{
                        ...
                        borderColor: isActive(node.path) ? `${node.color}80` : ''
                      }}
                    >
                      {/* Node Icon */}
                      ...
                      {isActive(node.path) && (
                        <motion.div
                          ...
                          animate={{
                            background: [
                              `linear-gradient(45deg, transparent, ${node.color}20, transparent)`,
                              `linear-gradient(45deg, ${node.color}10, transparent, ${node.color}10)`,
                              `linear-gradient(45deg, transparent, ${node.color}20, transparent)`
                            ]
                          }}
