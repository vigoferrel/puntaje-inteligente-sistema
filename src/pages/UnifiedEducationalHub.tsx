...
const UnifiedEducationalHubPage: React.FC = () => {
    ...
    <ErrorBoundary fallback={
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 flex items-center justify-center">
        <div className="text-center text-white">
          ...
          <p className="text-cyan-300 mb-4">No se pudo cargar el hub educativo. Reintentando...</p>
          <button 
      ...
      <UnifiedEducationalHub userId={user?.id || 'demo-user'} />
    </ErrorBoundary>
  );
};

export default UnifiedEducationalHubPage;
